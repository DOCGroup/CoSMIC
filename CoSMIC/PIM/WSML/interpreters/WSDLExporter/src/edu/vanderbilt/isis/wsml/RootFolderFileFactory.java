 ...
 *        RootFolderFileFactory gtf = FactoryRepository.getWSMLRootFolderFileFactory();
 *        RootFolder root = gtf.open("RootFolder-existingmodel.xml");
 * 
 ...
 * </pre></blockquote>
 */ 
public class RootFolderFileFactory
{
		 ...
		 throws UdmException 
	{
		...
		factory.getDiagram().getMetaClass(XsNmTokens.META_TYPE, XsNmTokens.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNcName.META_TYPE, XsNcName.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsToken.META_TYPE, XsToken.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsId.META_TYPE, XsId.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNegativeInteger.META_TYPE, XsNegativeInteger.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNonNegativeInteger.META_TYPE, XsNonNegativeInteger.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsPositiveInteger.META_TYPE, XsPositiveInteger.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsName.META_TYPE, XsName.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsIdRefs.META_TYPE, XsIdRefs.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsInteger.META_TYPE, XsInteger.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNormalizedString.META_TYPE, XsNormalizedString.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsEntity.META_TYPE, XsEntity.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNonPositiveInteger.META_TYPE, XsNonPositiveInteger.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsShort.META_TYPE, XsShort.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsUnsignedInt.META_TYPE, XsUnsignedInt.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsIdRef.META_TYPE, XsIdRef.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsLanguage.META_TYPE, XsLanguage.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsUnsignedByte.META_TYPE, XsUnsignedByte.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsInt.META_TYPE, XsInt.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNmToken.META_TYPE, XsNmToken.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsLong.META_TYPE, XsLong.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsEntities.META_TYPE, XsEntities.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsByte.META_TYPE, XsByte.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsUnsignedLong.META_TYPE, XsUnsignedLong.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsUnsignedShort.META_TYPE, XsUnsignedShort.META_TYPE_NS);
		...
		factory.getDiagram().getMetaClass(XsString.META_TYPE, XsString.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsQName.META_TYPE, XsQName.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsGYearMonth.META_TYPE, XsGYearMonth.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsDate.META_TYPE, XsDate.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsGMonthDay.META_TYPE, XsGMonthDay.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsFloat.META_TYPE, XsFloat.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsTime.META_TYPE, XsTime.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsBase64Binary.META_TYPE, XsBase64Binary.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsDouble.META_TYPE, XsDouble.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsBoolean.META_TYPE, XsBoolean.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsGMonth.META_TYPE, XsGMonth.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsHexBinary.META_TYPE, XsHexBinary.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsDuration.META_TYPE, XsDuration.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsNotation.META_TYPE, XsNotation.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsGDay.META_TYPE, XsGDay.META_TYPE_NS);
		factory.getDiagram().getMetaClass(SchemaBuiltins.META_TYPE, SchemaBuiltins.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsDecimal.META_TYPE, XsDecimal.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsDateTime.META_TYPE, XsDateTime.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsAnyUri.META_TYPE, XsAnyUri.META_TYPE_NS);
		factory.getDiagram().getMetaClass(XsGYear.META_TYPE, XsGYear.META_TYPE_NS);
	...
	/**
	 * Creates a new data network with root object of type <code>RootFolder</code> in the file specified by the parameter.
	 * @param  instanceFileName The name of the instance file
	 * @return  The root object of the data network
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public RootFolder create(String instanceFileName) 
		 throws UdmException
	{
		RootFolder root =
			new RootFolder(
				factory.createNewDataNetwork(instanceFileName, RootFolder.META_TYPE, RootFolder.META_TYPE_NS),
				factory.getDiagram());
		return root;
	}
	 ...
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public RootFolder open(String instanceFileName) 
		 throws UdmException
	{
		RootFolder root = 
			new RootFolder(
