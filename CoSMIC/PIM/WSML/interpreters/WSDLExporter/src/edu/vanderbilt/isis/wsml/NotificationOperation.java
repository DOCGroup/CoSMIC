...
/**
 * Domain specific class of <code>NotificationOperation</code>.
 */ 
public class NotificationOperation extends Operation
{
	// meta information
	public static final String META_TYPE = "NotificationOperation";
	 ...
	 */ 
	protected NotificationOperation(UdmPseudoObject upo, Diagram metaDiagram) 
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>NotificationOperation</code>
	 * @throws  UdmException If any Udm related exception occured
	 */ 
	public static NotificationOperation create(PortType parent) 
		throws UdmException 
	{
		Diagram metaDiagram = parent.getDiagram();
		return new NotificationOperation(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
