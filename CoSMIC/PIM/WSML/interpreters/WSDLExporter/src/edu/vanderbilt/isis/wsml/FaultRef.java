...
public class FaultRef extends MgaObject
{
	...
	/**
	 * Sets the other end of the association with role name <code>dstSOAPFaultExtension</code>.
	...
	public void setdstSOAPFaultExtension(SOAPFaultExtension a)
		throws UdmException
	{
		setAssociation("dstSOAPFaultExtension", a, UdmHelper.CLASS_FROM_TARGET);
	}

	/**
	 * Returns the other end of the association with role name <code>dstSOAPFaultExtension</code>.
	...
	public SOAPFaultExtension getdstSOAPFaultExtension()
		throws UdmException
	{
		UdmPseudoObject result = getSingleAssociatedObject("dstSOAPFaultExtension", UdmHelper.CLASS_FROM_TARGET);
