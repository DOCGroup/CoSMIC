...
int AMI4CCM_Event_Handler::handle_object_attribute (GAME::Mga::Object_in obj)
{
  ...
  model = GAME::Mga::Model::_narrow (file);
  ...
  {
    GAME::Mga::Model connector_object = GAME::Mga::Model::_narrow (results.front ());
    ...
    GAME::Mga::position ("TemplateParameters", pt, package_type);
    ...
    pt.shift (100, 0);
    GAME::Mga::position ("TemplateParameters", pt, tpv_interface);
    ...
    pt.shift (100, 0);
    GAME::Mga::position ("TemplateParameters", pt, tpv_replyhandler);
  }
  else
  {
