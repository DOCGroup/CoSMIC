...
private:
  /// Helper method for processing the Object as a IDML::File.
  void processObjectAsFile (const BON::Object & obj);

  /// Helper method for processing the FCO as a IDML::File.
  void processFCOAsFile (const BON::FCO & fco);
