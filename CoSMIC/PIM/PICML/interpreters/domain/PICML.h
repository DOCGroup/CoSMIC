...
// generated on Fri Dec 03 16:04:28 2004
...
namespace PICML {
	...
	class  Component :  public SupportsInterfaces, public Manageable, public NamedType {
	 public:
		static Uml::Class meta;

		Component() { }
		Component(Udm::ObjectImpl *impl) : SupportsInterfaces(impl),Manageable(impl),NamedType(impl), MgaObject(impl), Object(impl) { }
		Component(const Component &master) : SupportsInterfaces(master),Manageable(master),NamedType(master), MgaObject(master), Object(master) { }
