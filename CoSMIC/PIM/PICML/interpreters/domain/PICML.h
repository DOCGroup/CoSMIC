...
namespace PICML {
	...
	class  Object :  public Prefixable, public Provideable, public HasOperations {
	 public:
		...
		Object() { }
		Object(Udm::ObjectImpl *impl) : Prefixable(impl),Provideable(impl),HasOperations(impl), Inheritable(impl), MgaObject(impl) { }
		Object(const Object &master) : Prefixable(master),Provideable(master),HasOperations(master), Inheritable(master), MgaObject(master) { }
