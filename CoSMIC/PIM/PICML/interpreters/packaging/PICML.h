...
// generated on Wed Jun 09 13:57:10 2004
...
namespace PICML {
	...
	class  TopLevelPackageFolder :  public Udm::Object {
	 public:
		...
		static TopLevelPackageFolder Cast(const Udm::Object &a) { return __Cast(a, meta); }

		static TopLevelPackageFolder Create(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role); }

		TopLevelPackageFolder CreateInstance(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl); }

		TopLevelPackageFolder CreateDerived(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl, true); }
		...
		virtual void Accept(Visitor &v){v.Visit_TopLevelPackageFolder(*this);};
	};
	...
	class  ObjectByValue :  public Prefixable, public SupportsInterfaces, public HasOperations {
	 public:
		...
		ObjectByValue() { }
		ObjectByValue(Udm::ObjectImpl *impl) : Prefixable(impl),SupportsInterfaces(impl),HasOperations(impl), Inheritable(impl), MgaObject(impl) { }
		ObjectByValue(const ObjectByValue &master) : Prefixable(master),SupportsInterfaces(master),HasOperations(master), Inheritable(master), MgaObject(master) { }
