...
// generated on Fri Dec 03 16:04:56 2004
...
namespace PICML {
	...
	Uml::CompositionChildRole ServantProject::meta_FileRef_children;
	...
	void InitComposition23()
	{
		...
		ServantProject::meta_FileRef_children = Uml::CompositionChildRole::Create(comp);
		ServantProject::meta_FileRef_children.name() = "FileRef";
		ServantProject::meta_FileRef_children.min() = 0;
		ServantProject::meta_FileRef_children.max() = -1;
		ServantProject::meta_FileRef_children.isNavigable() = true;
		ServantProject::meta_FileRef_children.target() = FileRef::meta;
	}
	...
	void Initialize(const Uml::Diagram & dgr)
	{
		...
		Uml::SetChildRole(ServantProject::meta_FileRef_children,ServantProject::meta,FileRef::meta, "", "");
