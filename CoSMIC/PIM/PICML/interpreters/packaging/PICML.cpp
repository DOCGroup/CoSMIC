...
// generated on Wed Feb 16 10:52:39 2005
...
namespace PICML {
	...
	void InitClassesAttributes()
	{
		...
		TaskSet::meta_priority.defvalue() = vector<string>();
		...
		MetricsBase::meta_priority.defvalue() = vector<string>();
		vector<string> MetricsBase_rate_dva;
		MetricsBase_rate_dva.push_back("0");
