...
// generated on Wed Jul 21 11:33:28 2004
...
namespace PICML {
	...
	void InitClassesAttributes()
	{
		...
		Inheritable::meta_UniqueInheritableDeclNames.expression() = "(parts () - parts (\"Inherits\") - parts (\"Supports\"))->forAll (x, y : gme::FCO | x <> y implies x.name <> y.name)";
