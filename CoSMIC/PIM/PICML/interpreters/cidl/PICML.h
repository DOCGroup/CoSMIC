...
// generated on Fri Oct 22 10:01:01 2004
...
namespace PICML {
	...
	class  Object :  public HasOperations, public Provideable, public Prefixable {
	 public:
		...
		Object() { }
		Object(Udm::ObjectImpl *impl) : HasOperations(impl),Provideable(impl),Prefixable(impl), MgaObject(impl), Object(impl) { }
		Object(const Object &master) : HasOperations(master),Provideable(master),Prefixable(master), MgaObject(master), Object(master) { }
	...
	class  Use_RT_Info :  public MgaObject {
	 public:
		...
		Udm::AssocEndAttr<PICML::RT_Info_Param> dstUse_RT_Info_end() const { return Udm::AssocEndAttr<PICML::RT_Info_Param>(impl, meta_dstUse_RT_Info_end_); }

		static Uml::AssociationRole meta_srcUse_RT_Info_end_;
		Udm::AssocEndAttr<PICML::RTEC_Resource_Factory_Reference> srcUse_RT_Info_end() const { return Udm::AssocEndAttr<PICML::RTEC_Resource_Factory_Reference>(impl, meta_srcUse_RT_Info_end_); }
	...
	class  RT_Info_Param :  public MgaObject {
	 public:
		...
		Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RTEC_Resource_Factory_Reference> srcUse_RT_Info() const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RTEC_Resource_Factory_Reference>(impl, meta_srcUse_RT_Info, meta_srcUse_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RTEC_Resource_Factory_Reference, Pred> srcUse_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RTEC_Resource_Factory_Reference, Pred>(impl, meta_srcUse_RT_Info, meta_srcUse_RT_Info_rev); }
	...
	class  RTEC_Resource_Factory_Reference :  public MgaObject {
	 public:
		...
		Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RT_Info_Param> dstUse_RT_Info() const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RT_Info_Param>(impl, meta_dstUse_RT_Info, meta_dstUse_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RT_Info_Param, Pred> dstUse_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::RT_Info_Param, Pred>(impl, meta_dstUse_RT_Info, meta_dstUse_RT_Info_rev); }
