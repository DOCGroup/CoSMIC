...
// generated on Fri Dec 03 18:00:09 2004
...
namespace PICML {
	...
	class  Object :  public Provideable, public HasOperations, public Prefixable {
	 public:
		static Uml::Class meta;

		Object() { }
		Object(Udm::ObjectImpl *impl) : Provideable(impl),HasOperations(impl),Prefixable(impl), MgaObject(impl), Object(impl) { }
		Object(const Object &master) : Provideable(master),HasOperations(master),Prefixable(master), MgaObject(master), Object(master) { }
