...
// generated on Wed Feb 16 13:21:47 2005
...
namespace PICML {
	...
	class  Object :  public Prefixable, public HasOperations, public Provideable {
	 public:
		static Uml::Class meta;

		Object() { }
		Object(Udm::ObjectImpl *impl) : Prefixable(impl),HasOperations(impl),Provideable(impl), MgaObject(impl), Object(impl) { }
		Object(const Object &master) : Prefixable(master),HasOperations(master),Provideable(master), MgaObject(master), Object(master) { }
