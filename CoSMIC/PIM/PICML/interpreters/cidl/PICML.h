...
// generated on Mon Nov 01 16:57:06 2004
...
namespace PICML {
	...
	class  Component :  public SupportsInterfaces, public NamedType, public Manageable {
	 public:
		static Uml::Class meta;

		Component() { }
		Component(Udm::ObjectImpl *impl) : SupportsInterfaces(impl),NamedType(impl),Manageable(impl), MgaObject(impl), Object(impl) { }
		Component(const Component &master) : SupportsInterfaces(master),NamedType(master),Manageable(master), MgaObject(master), Object(master) { }
