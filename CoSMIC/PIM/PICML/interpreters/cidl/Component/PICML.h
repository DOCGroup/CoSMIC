...
// generated on Wed Jul 21 11:33:26 2004
...
namespace PICML {
	...
	class  ComponentFactory :  public SupportsInterfaces, public HasOperations {
	 public:
		...
		ComponentFactory() { }
		ComponentFactory(Udm::ObjectImpl *impl) : SupportsInterfaces(impl),HasOperations(impl), Inheritable(impl), MgaObject(impl) { }
		ComponentFactory(const ComponentFactory &master) : SupportsInterfaces(master),HasOperations(master), Inheritable(master), MgaObject(master) { }
	...
	class  Package :  public Taggable, public Prefixable {
	 public:
		...
		Package() { }
		Package(Udm::ObjectImpl *impl) : Taggable(impl),Prefixable(impl), MgaObject(impl) { }
		Package(const Package &master) : Taggable(master),Prefixable(master), MgaObject(master) { }
		static Package Cast(const Udm::Object &a) { return __Cast(a, meta); }
	...
	class  ObjectByValue :  public SupportsInterfaces, public HasOperations, public Prefixable {
	 public:
		static Uml::Class meta;

		ObjectByValue() { }
		ObjectByValue(Udm::ObjectImpl *impl) : SupportsInterfaces(impl),HasOperations(impl),Prefixable(impl), Inheritable(impl), MgaObject(impl) { }
		ObjectByValue(const ObjectByValue &master) : SupportsInterfaces(master),HasOperations(master),Prefixable(master), Inheritable(master), MgaObject(master) { }
