...
MIDL_DEFINE_GUID(IID, LIBID_MgaComponentLib,0xC0F50EDE,0x7DDC,0x4b08,0xB7,0x4D,0x64,0xE9,0x19,0x2E,0x64,0xD1);


MIDL_DEFINE_GUID(CLSID, CLSID_MgaComponent,0x90D86A06,0x136C,0x48a9,0x80,0xFD,0xAA,0xED,0x45,0x54,0x1A,0xD6);
