...
// generated on Wed Feb 16 10:52:36 2005
...
namespace PICML {
	...
	class  Component :  public NamedType, public Manageable, public SupportsInterfaces {
	 public:
		static Uml::Class meta;

		Component() { }
		Component(Udm::ObjectImpl *impl) : NamedType(impl),Manageable(impl),SupportsInterfaces(impl), MgaObject(impl), Object(impl) { }
		Component(const Component &master) : NamedType(master),Manageable(master),SupportsInterfaces(master), MgaObject(master), Object(master) { }
