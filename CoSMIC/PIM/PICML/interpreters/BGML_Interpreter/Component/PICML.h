...
// generated on Fri Oct 08 11:05:00 2004
...
namespace PICML {
	...
	class  Use_RT_Info_Members_Base;
	class  Include_RTEC_Filter_Group_Members_Base;
	class  Include_RT_Info_Members_Base;
	...
	class  Use_RT_Info_Members_Base :  virtual public Udm::Object {
	 public:
		static Uml::Class meta;

		Use_RT_Info_Members_Base() { }
		Use_RT_Info_Members_Base(Udm::ObjectImpl *impl) : Object(impl) { }
		Use_RT_Info_Members_Base(const Use_RT_Info_Members_Base &master) : Object(master) { }
		static Use_RT_Info_Members_Base Cast(const Udm::Object &a) { return __Cast(a, meta); }

		static Use_RT_Info_Members_Base Create(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role); }

		Use_RT_Info_Members_Base CreateInstance(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl); }

		Use_RT_Info_Members_Base CreateDerived(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl, true); }

		Udm::InstantiatedAttr<Use_RT_Info_Members_Base> Instances() { return Udm::InstantiatedAttr<PICML::Use_RT_Info_Members_Base>(impl);}
		template <class Pred> Udm::InstantiatedAttr<Use_RT_Info_Members_Base, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICML::Use_RT_Info_Members_Base, Pred>(impl);}

		Udm::DerivedAttr<PICML::Use_RT_Info_Members_Base> Derived() { return Udm::DerivedAttr<PICML::Use_RT_Info_Members_Base>(impl);}
		template <class Pred> Udm::DerivedAttr<PICML::Use_RT_Info_Members_Base, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICML::Use_RT_Info_Members_Base, Pred>(impl);}

		Udm::ArchetypeAttr<PICML::Use_RT_Info_Members_Base> Archetype() { return Udm::ArchetypeAttr<PICML::Use_RT_Info_Members_Base>(impl);}

		static Uml::AssociationRole meta_srcUse_RT_Info, meta_srcUse_RT_Info_rev;
		Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base> srcUse_RT_Info() const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base>(impl, meta_srcUse_RT_Info, meta_srcUse_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base, Pred> srcUse_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base, Pred>(impl, meta_srcUse_RT_Info, meta_srcUse_RT_Info_rev); }

		static Uml::AssociationRole meta_dstUse_RT_Info, meta_dstUse_RT_Info_rev;
		Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base> dstUse_RT_Info() const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base>(impl, meta_dstUse_RT_Info, meta_dstUse_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base, Pred> dstUse_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Use_RT_Info, PICML::Use_RT_Info_Members_Base, Pred>(impl, meta_dstUse_RT_Info, meta_dstUse_RT_Info_rev); }
	...
	class  Include_RT_Info_Members_Base :  virtual public Udm::Object {
	 public:
		static Uml::Class meta;

		Include_RT_Info_Members_Base() { }
		Include_RT_Info_Members_Base(Udm::ObjectImpl *impl) : Object(impl) { }
		Include_RT_Info_Members_Base(const Include_RT_Info_Members_Base &master) : Object(master) { }
		static Include_RT_Info_Members_Base Cast(const Udm::Object &a) { return __Cast(a, meta); }

		static Include_RT_Info_Members_Base Create(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role); }

		Include_RT_Info_Members_Base CreateInstance(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl); }

		Include_RT_Info_Members_Base CreateDerived(const Udm::Object &parent, const Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl, true); }

		Udm::InstantiatedAttr<Include_RT_Info_Members_Base> Instances() { return Udm::InstantiatedAttr<PICML::Include_RT_Info_Members_Base>(impl);}
		template <class Pred> Udm::InstantiatedAttr<Include_RT_Info_Members_Base, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICML::Include_RT_Info_Members_Base, Pred>(impl);}

		Udm::DerivedAttr<PICML::Include_RT_Info_Members_Base> Derived() { return Udm::DerivedAttr<PICML::Include_RT_Info_Members_Base>(impl);}
		template <class Pred> Udm::DerivedAttr<PICML::Include_RT_Info_Members_Base, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICML::Include_RT_Info_Members_Base, Pred>(impl);}

		Udm::ArchetypeAttr<PICML::Include_RT_Info_Members_Base> Archetype() { return Udm::ArchetypeAttr<PICML::Include_RT_Info_Members_Base>(impl);}

		static Uml::AssociationRole meta_srcInclude_RT_Info, meta_srcInclude_RT_Info_rev;
		Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base> srcInclude_RT_Info() const { return Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base>(impl, meta_srcInclude_RT_Info, meta_srcInclude_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base, Pred> srcInclude_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base, Pred>(impl, meta_srcInclude_RT_Info, meta_srcInclude_RT_Info_rev); }

		static Uml::AssociationRole meta_dstInclude_RT_Info, meta_dstInclude_RT_Info_rev;
		Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base> dstInclude_RT_Info() const { return Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base>(impl, meta_dstInclude_RT_Info, meta_dstInclude_RT_Info_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base, Pred> dstInclude_RT_Info_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::Include_RT_Info, PICML::Include_RT_Info_Members_Base, Pred>(impl, meta_dstInclude_RT_Info, meta_dstInclude_RT_Info_rev); }
	...
	class  RTEC_Proxy :  virtual public MgaObject {
	 public:
		...
		Udm::ChildrenAttr<PICML::Use_RT_Info_Members_Base> Use_RT_Info_Members_Base_kind_children() const { return Udm::ChildrenAttr<PICML::Use_RT_Info_Members_Base>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICML::Use_RT_Info_Members_Base, Pred> Use_RT_Info_Members_Base_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICML::Use_RT_Info_Members_Base, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICML::Include_RT_Info_Members_Base> Include_RT_Info_Members_Base_kind_children() const { return Udm::ChildrenAttr<PICML::Include_RT_Info_Members_Base>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICML::Include_RT_Info_Members_Base, Pred> Include_RT_Info_Members_Base_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICML::Include_RT_Info_Members_Base, Pred>(impl, Udm::NULLCHILDROLE); }
	...
	class  Use_RT_Info :  public MgaObject {
	 public:
		...
		Udm::AssocEndAttr<PICML::Use_RT_Info_Members_Base> dstUse_RT_Info_end() const { return Udm::AssocEndAttr<PICML::Use_RT_Info_Members_Base>(impl, meta_dstUse_RT_Info_end_); }

		static Uml::AssociationRole meta_srcUse_RT_Info_end_;
		Udm::AssocEndAttr<PICML::Use_RT_Info_Members_Base> srcUse_RT_Info_end() const { return Udm::AssocEndAttr<PICML::Use_RT_Info_Members_Base>(impl, meta_srcUse_RT_Info_end_); }

		virtual void Accept(Visitor &v){v.Visit_Use_RT_Info(*this);};
	};

	class  RTEC_Filter_Group :  public Include_RTEC_Filter_Group_Members_Base, public Include_RT_Info_Members_Base, public MgaObject {
	 public:
		static Uml::Class meta;

		RTEC_Filter_Group() { }
		RTEC_Filter_Group(Udm::ObjectImpl *impl) : Include_RTEC_Filter_Group_Members_Base(impl),Include_RT_Info_Members_Base(impl),MgaObject(impl), Object(impl) { }
		RTEC_Filter_Group(const RTEC_Filter_Group &master) : Include_RTEC_Filter_Group_Members_Base(master),Include_RT_Info_Members_Base(master),MgaObject(master), Object(master) { }
	...
	class  Include_RT_Info :  public MgaObject {
	 public:
		...
		Udm::AssocEndAttr<PICML::Include_RT_Info_Members_Base> dstInclude_RT_Info_end() const { return Udm::AssocEndAttr<PICML::Include_RT_Info_Members_Base>(impl, meta_dstInclude_RT_Info_end_); }

		static Uml::AssociationRole meta_srcInclude_RT_Info_end_;
		Udm::AssocEndAttr<PICML::Include_RT_Info_Members_Base> srcInclude_RT_Info_end() const { return Udm::AssocEndAttr<PICML::Include_RT_Info_Members_Base>(impl, meta_srcInclude_RT_Info_end_); }
	...
	class  RTEC_Resource_Factory_Reference :  public Use_RT_Info_Members_Base, public MgaObject {
	 public:
		static Uml::Class meta;

		RTEC_Resource_Factory_Reference() { }
		RTEC_Resource_Factory_Reference(Udm::ObjectImpl *impl) : Use_RT_Info_Members_Base(impl),MgaObject(impl), Object(impl) { }
		RTEC_Resource_Factory_Reference(const RTEC_Resource_Factory_Reference &master) : Use_RT_Info_Members_Base(master),MgaObject(master), Object(master) { }
	...
	class  RT_Info_Param :  public Use_RT_Info_Members_Base, public Include_RT_Info_Members_Base, public MgaObject {
	 public:
		static Uml::Class meta;

		RT_Info_Param() { }
		RT_Info_Param(Udm::ObjectImpl *impl) : Use_RT_Info_Members_Base(impl),Include_RT_Info_Members_Base(impl),MgaObject(impl), Object(impl) { }
		RT_Info_Param(const RT_Info_Param &master) : Use_RT_Info_Members_Base(master),Include_RT_Info_Members_Base(master),MgaObject(master), Object(master) { }
	...
	class  Task :  public MgaObject {
	 public:
		...
		static Uml::AssociationRole meta_TaskSet;
		Udm::AssocAttr<PICML::TaskSet> TaskSet() const { return Udm::AssocAttr<PICML::TaskSet>(impl, meta_TaskSet); }
		template <class Pred> Udm::AssocAttr<PICML::TaskSet, Pred > TaskSet_sorted(const Pred &) const { return Udm::AssocAttr<PICML::TaskSet, Pred>(impl, meta_TaskSet); }
	...
	class  TimeProbe :  public MgaObject {
	 public:
		...
		Udm::AClassAssocAttr<PICML::TimerEventSinkConn, PICML::EventRef> srcTimerEventSinkConn() const { return Udm::AClassAssocAttr<PICML::TimerEventSinkConn, PICML::EventRef>(impl, meta_srcTimerEventSinkConn, meta_srcTimerEventSinkConn_rev); }
		template<class Pred> Udm::AClassAssocAttr<PICML::TimerEventSinkConn, PICML::EventRef, Pred> srcTimerEventSinkConn_sorted(const Pred &) const { return Udm::AClassAssocAttr<PICML::TimerEventSinkConn, PICML::EventRef, Pred>(impl, meta_srcTimerEventSinkConn, meta_srcTimerEventSinkConn_rev); }
	...
	class  ComponentFactory :  public SupportsInterfaces, public HasOperations {
	 public:
		static Uml::Class meta;

		ComponentFactory() { }
		ComponentFactory(Udm::ObjectImpl *impl) : SupportsInterfaces(impl),HasOperations(impl), MgaObject(impl), Object(impl) { }
		ComponentFactory(const ComponentFactory &master) : SupportsInterfaces(master),HasOperations(master), MgaObject(master), Object(master) { }
	...
	class  ObjectByValue :  public Prefixable, public SupportsInterfaces, public HasOperations {
	 public:
		static Uml::Class meta;

		ObjectByValue() { }
		ObjectByValue(Udm::ObjectImpl *impl) : Prefixable(impl),SupportsInterfaces(impl),HasOperations(impl), MgaObject(impl), Object(impl) { }
		ObjectByValue(const ObjectByValue &master) : Prefixable(master),SupportsInterfaces(master),HasOperations(master), MgaObject(master), Object(master) { }
	...
	class  Package :  public Taggable, public Prefixable {
	 public:
		static Uml::Class meta;

		Package() { }
		Package(Udm::ObjectImpl *impl) : Taggable(impl),Prefixable(impl), MgaObject(impl), Object(impl) { }
		Package(const Package &master) : Taggable(master),Prefixable(master), MgaObject(master), Object(master) { }
		static Package Cast(const Udm::Object &a) { return __Cast(a, meta); }
	...
	class  Workspace :  public MgaObject {
	 public:
		...
		Workspace() { }
		Workspace(Udm::ObjectImpl *impl) : MgaObject(impl), Object(impl) { }
		Workspace(const Workspace &master) : MgaObject(master), Object(master) { }
