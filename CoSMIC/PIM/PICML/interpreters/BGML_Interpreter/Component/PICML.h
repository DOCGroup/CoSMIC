...
// generated on Wed Aug 25 21:40:06 2004
...
namespace PICML {
	...
	class  Port :  public Taggable, public CommonPortAttrs {
	 public:
		...
		Port() { }
		Port(Udm::ObjectImpl *impl) : Taggable(impl),CommonPortAttrs(impl), MgaObject(impl) { }
		Port(const Port &master) : Taggable(master),CommonPortAttrs(master), MgaObject(master) { }
	...
	class  Object :  public Prefixable, public HasOperations, public Provideable {
	 public:
		...
		Object() { }
		Object(Udm::ObjectImpl *impl) : Prefixable(impl),HasOperations(impl),Provideable(impl), Inheritable(impl), MgaObject(impl) { }
		Object(const Object &master) : Prefixable(master),HasOperations(master),Provideable(master), Inheritable(master), MgaObject(master) { }
