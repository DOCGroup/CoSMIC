...
// generated on Thu Apr 07 16:42:13 2005
...
namespace PICML {
	...
	Uml::AssociationRole BenchmarkType::meta_dstBenchmarkCharacteristics, BenchmarkType::meta_dstBenchmarkCharacteristics_rev;
	...
	Uml::AssociationRole MetricsBase::meta_srcBenchmarkCharacteristics, MetricsBase::meta_srcBenchmarkCharacteristics_rev;
	...
	Uml::AssociationRole OperationRef::meta_dstComponentOperation, OperationRef::meta_dstComponentOperation_rev;
	Uml::AssociationRole OperationRef::meta_dstWorkLoadOperationConnection, OperationRef::meta_dstWorkLoadOperationConnection_rev;
	...
	Uml::AssociationRole Task::meta_srcWorkLoadOperationConnection, Task::meta_srcWorkLoadOperationConnection_rev;
	...
	Uml::AssociationRole CompRef::meta_srcComponentOperation, CompRef::meta_srcComponentOperation_rev;
	...
	void Creates()
	{
		...
		BenchmarkType::meta = Uml::Class::Create(umldiagram);
		WorkLoadOperationConnection::meta = Uml::Class::Create(umldiagram);
		BenchmarkCharacteristics::meta = Uml::Class::Create(umldiagram);
		...
		FixedIterationBenchmarks::meta = Uml::Class::Create(umldiagram);
		ComponentOperation::meta = Uml::Class::Create(umldiagram);
		CompRef::meta = Uml::Class::Create(umldiagram);
		TriggerBenchmarks::meta = Uml::Class::Create(umldiagram);
		PeriodicBenchmarks::meta = Uml::Class::Create(umldiagram);
	...
	void InitClassesAttributes()
	{
		...
		BenchmarkType::meta.name() = "BenchmarkType";
		BenchmarkType::meta.isAbstract() = true;
		BenchmarkType::meta.stereotype() = "FCO";
		WorkLoadOperationConnection::meta.name() = "WorkLoadOperationConnection";
		WorkLoadOperationConnection::meta.isAbstract() = false;
		WorkLoadOperationConnection::meta.stereotype() = "Connection";
		BenchmarkCharacteristics::meta.name() = "BenchmarkCharacteristics";
		BenchmarkCharacteristics::meta.isAbstract() = false;
		BenchmarkCharacteristics::meta.stereotype() = "Connection";
		...
		FixedIterationBenchmarks::meta.name() = "FixedIterationBenchmarks";
		FixedIterationBenchmarks::meta.isAbstract() = false;
		FixedIterationBenchmarks::meta.stereotype() = "Atom";
		ComponentOperation::meta.name() = "ComponentOperation";
		ComponentOperation::meta.isAbstract() = false;
		ComponentOperation::meta.stereotype() = "Connection";
		CompRef::meta.name() = "CompRef";
		CompRef::meta.isAbstract() = false;
		CompRef::meta.stereotype() = "Reference";
		TriggerBenchmarks::meta.name() = "TriggerBenchmarks";
		TriggerBenchmarks::meta.isAbstract() = false;
		TriggerBenchmarks::meta.stereotype() = "Atom";
		PeriodicBenchmarks::meta.name() = "PeriodicBenchmarks";
		PeriodicBenchmarks::meta.isAbstract() = false;
		PeriodicBenchmarks::meta.stereotype() = "Atom";
		...
		MetricsBase::meta_priority.name() = "priority";
		MetricsBase::meta_priority.type() = "Integer";
		MetricsBase::meta_priority.min() = 1;
		MetricsBase::meta_priority.max() = 1;
		MetricsBase::meta_priority.nonpersistent() = false;
		MetricsBase::meta_priority.registry() = false;
		MetricsBase::meta_priority.ordered() = false;
		MetricsBase::meta_priority.visibility() = "public";
		MetricsBase::meta_priority.defvalue() = MetricsBase_priority_dva;
		vector<string> MetricsBase_rate_dva;
		MetricsBase_rate_dva.push_back("-1");
		MetricsBase::meta_rate.name() = "rate";
		MetricsBase::meta_rate.type() = "Integer";
		MetricsBase::meta_rate.min() = 1;
		MetricsBase::meta_rate.max() = 1;
		MetricsBase::meta_rate.nonpersistent() = false;
		MetricsBase::meta_rate.registry() = false;
		MetricsBase::meta_rate.ordered() = false;
		MetricsBase::meta_rate.visibility() = "public";
		MetricsBase::meta_rate.defvalue() = MetricsBase_rate_dva;
		vector<string> MetricsBase_resolution_dva;
		MetricsBase_resolution_dva.push_back("microseconds");
		MetricsBase::meta_resolution.name() = "resolution";
		MetricsBase::meta_resolution.type() = "String";
		MetricsBase::meta_resolution.min() = 1;
		MetricsBase::meta_resolution.max() = 1;
		MetricsBase::meta_resolution.nonpersistent() = false;
		MetricsBase::meta_resolution.registry() = false;
		MetricsBase::meta_resolution.ordered() = false;
		MetricsBase::meta_resolution.visibility() = "public";
		MetricsBase::meta_resolution.defvalue() = MetricsBase_resolution_dva;
		vector<string> TaskSet_rate_dva;
		TaskSet_rate_dva.push_back("-1");
		TaskSet::meta_rate.name() = "rate";
		TaskSet::meta_rate.type() = "Integer";
		TaskSet::meta_rate.min() = 1;
		TaskSet::meta_rate.max() = 1;
		TaskSet::meta_rate.nonpersistent() = false;
		TaskSet::meta_rate.registry() = false;
		TaskSet::meta_rate.ordered() = false;
		TaskSet::meta_rate.visibility() = "public";
		TaskSet::meta_rate.defvalue() = TaskSet_rate_dva;
		vector<string> TaskSet_priority_dva;
		TaskSet_priority_dva.push_back("-1");
		TaskSet::meta_priority.name() = "priority";
		TaskSet::meta_priority.type() = "Integer";
		TaskSet::meta_priority.min() = 1;
		TaskSet::meta_priority.max() = 1;
		TaskSet::meta_priority.nonpersistent() = false;
		TaskSet::meta_priority.registry() = false;
		TaskSet::meta_priority.ordered() = false;
		TaskSet::meta_priority.visibility() = "public";
		TaskSet::meta_priority.defvalue() = TaskSet_priority_dva;
		FixedIterationBenchmarks::meta_benchmarkIterations.name() = "benchmarkIterations";
		FixedIterationBenchmarks::meta_benchmarkIterations.type() = "Integer";
		FixedIterationBenchmarks::meta_benchmarkIterations.min() = 1;
		FixedIterationBenchmarks::meta_benchmarkIterations.max() = 1;
		FixedIterationBenchmarks::meta_benchmarkIterations.nonpersistent() = false;
		FixedIterationBenchmarks::meta_benchmarkIterations.registry() = false;
		FixedIterationBenchmarks::meta_benchmarkIterations.ordered() = false;
		FixedIterationBenchmarks::meta_benchmarkIterations.visibility() = "public";
		FixedIterationBenchmarks::meta_benchmarkIterations.defvalue() = vector<string>();
		PeriodicBenchmarks::meta_timeperiod.name() = "timeperiod";
		PeriodicBenchmarks::meta_timeperiod.type() = "Integer";
		PeriodicBenchmarks::meta_timeperiod.min() = 1;
		PeriodicBenchmarks::meta_timeperiod.max() = 1;
		PeriodicBenchmarks::meta_timeperiod.nonpersistent() = false;
		PeriodicBenchmarks::meta_timeperiod.registry() = false;
		PeriodicBenchmarks::meta_timeperiod.ordered() = false;
		PeriodicBenchmarks::meta_timeperiod.visibility() = "public";
		PeriodicBenchmarks::meta_timeperiod.defvalue() = vector<string>();
	...
	{
		Uml::Association ass = Uml::Association::Create(umldiagram);
		ass.name() = "BenchmarkCharacteristics";
		ass.assocClass() = BenchmarkCharacteristics::meta;
		MetricsBase::meta_srcBenchmarkCharacteristics = Uml::AssociationRole::Create(ass);
		MetricsBase::meta_srcBenchmarkCharacteristics.name() = "srcBenchmarkCharacteristics";
		MetricsBase::meta_srcBenchmarkCharacteristics.min() = 1;
		MetricsBase::meta_srcBenchmarkCharacteristics.max() = 1;
		MetricsBase::meta_srcBenchmarkCharacteristics.isNavigable() = true;
		MetricsBase::meta_srcBenchmarkCharacteristics.isPrimary() = false;
		...
		BenchmarkType::meta_dstBenchmarkCharacteristics.name() = "dstBenchmarkCharacteristics";
		BenchmarkType::meta_dstBenchmarkCharacteristics.min() = 0;
		BenchmarkType::meta_dstBenchmarkCharacteristics.max() = 1;
		BenchmarkType::meta_dstBenchmarkCharacteristics.isNavigable() = true;
		BenchmarkType::meta_dstBenchmarkCharacteristics.isPrimary() = false;
	...
	{
		Uml::Association ass = Uml::Association::Create(umldiagram);
		ass.name() = "ComponentOperation";
		ass.assocClass() = ComponentOperation::meta;
		OperationRef::meta_dstComponentOperation = Uml::AssociationRole::Create(ass);
		OperationRef::meta_dstComponentOperation.name() = "dstComponentOperation";
		OperationRef::meta_dstComponentOperation.min() = 0;
		OperationRef::meta_dstComponentOperation.max() = 1;
		OperationRef::meta_dstComponentOperation.isNavigable() = true;
		OperationRef::meta_dstComponentOperation.isPrimary() = false;
		...
		CompRef::meta_srcComponentOperation.name() = "srcComponentOperation";
		CompRef::meta_srcComponentOperation.min() = 1;
		CompRef::meta_srcComponentOperation.max() = 1;
		CompRef::meta_srcComponentOperation.isNavigable() = true;
		CompRef::meta_srcComponentOperation.isPrimary() = false;
	...
	{
		Uml::Association ass = Uml::Association::Create(umldiagram);
		ass.name() = "WorkLoadOperationConnection";
		ass.assocClass() = WorkLoadOperationConnection::meta;
		OperationRef::meta_dstWorkLoadOperationConnection = Uml::AssociationRole::Create(ass);
		OperationRef::meta_dstWorkLoadOperationConnection.name() = "dstWorkLoadOperationConnection";
		OperationRef::meta_dstWorkLoadOperationConnection.min() = 0;
		OperationRef::meta_dstWorkLoadOperationConnection.max() = 1;
		OperationRef::meta_dstWorkLoadOperationConnection.isNavigable() = true;
		OperationRef::meta_dstWorkLoadOperationConnection.isPrimary() = false;
		...
		Task::meta_srcWorkLoadOperationConnection.name() = "srcWorkLoadOperationConnection";
		Task::meta_srcWorkLoadOperationConnection.min() = 0;
		Task::meta_srcWorkLoadOperationConnection.max() = 1;
		Task::meta_srcWorkLoadOperationConnection.isNavigable() = true;
		Task::meta_srcWorkLoadOperationConnection.isPrimary() = false;
	...
	void InitAssociation14()
	{
		...
		CompRef::meta_ref.name() = "ref";
		CompRef::meta_ref.min() = 0;
		CompRef::meta_ref.max() = 1;
		CompRef::meta_ref.isNavigable() = true;
		CompRef::meta_ref.isPrimary() = false;
		CompRef::meta_ref.target() = Component::meta;
		Component::meta_referedbyCompRef = Uml::AssociationRole::Create(ass);
		Component::meta_referedbyCompRef.name() = "referedbyCompRef";
		Component::meta_referedbyCompRef.min() = 0;
		Component::meta_referedbyCompRef.max() = -1;
		Component::meta_referedbyCompRef.isNavigable() = true;
		Component::meta_referedbyCompRef.isPrimary() = false;
	...
	void InitComposition7()
	{
		...
		StubProject::meta_FileRef_child.name() = "FileRef";
		StubProject::meta_FileRef_child.min() = 1;
		StubProject::meta_FileRef_child.max() = 1;
		StubProject::meta_FileRef_child.isNavigable() = true;
	...
	void InitComposition9()
	{
		...
		FileRef::meta_ServantProject_parent.name() = "ServantProject_parent";
		FileRef::meta_ServantProject_parent.isNavigable() = true;
		...
		ServantProject::meta_FileRef_child.name() = "FileRef";
		ServantProject::meta_FileRef_child.min() = 0;
		ServantProject::meta_FileRef_child.max() = 1;
		ServantProject::meta_FileRef_child.isNavigable() = true;
	...
	void InitComposition13()
	{
		...
		ComponentOperation::meta_BenchmarkAnalysis_parent.name() = "BenchmarkAnalysis_parent";
		ComponentOperation::meta_BenchmarkAnalysis_parent.isNavigable() = true;
		...
		BenchmarkAnalysis::meta_ComponentOperation_children.name() = "ComponentOperation";
		BenchmarkAnalysis::meta_ComponentOperation_children.min() = 0;
		BenchmarkAnalysis::meta_ComponentOperation_children.max() = -1;
		BenchmarkAnalysis::meta_ComponentOperation_children.isNavigable() = true;
	...
	void InitComposition18()
	{
		...
		BenchmarkType::meta_BenchmarkAnalysis_parent.name() = "BenchmarkAnalysis_parent";
		BenchmarkType::meta_BenchmarkAnalysis_parent.isNavigable() = true;
		...
		BenchmarkAnalysis::meta_BenchmarkType_children.name() = "BenchmarkType";
		BenchmarkAnalysis::meta_BenchmarkType_children.min() = 0;
		BenchmarkAnalysis::meta_BenchmarkType_children.max() = -1;
		BenchmarkAnalysis::meta_BenchmarkType_children.isNavigable() = true;
	...
	void InitComposition21()
	{
		...
		CompRef::meta_BenchmarkAnalysis_parent.name() = "BenchmarkAnalysis_parent";
		CompRef::meta_BenchmarkAnalysis_parent.isNavigable() = true;
		...
		BenchmarkAnalysis::meta_CompRef_children.name() = "CompRef";
		BenchmarkAnalysis::meta_CompRef_children.min() = 0;
		BenchmarkAnalysis::meta_CompRef_children.max() = -1;
		BenchmarkAnalysis::meta_CompRef_children.isNavigable() = true;
	...
	void InitComposition22()
	{
		...
		WorkLoadOperationConnection::meta_BenchmarkAnalysis_parent.name() = "BenchmarkAnalysis_parent";
		WorkLoadOperationConnection::meta_BenchmarkAnalysis_parent.isNavigable() = true;
		...
		BenchmarkAnalysis::meta_WorkLoadOperationConnection_children.name() = "WorkLoadOperationConnection";
		BenchmarkAnalysis::meta_WorkLoadOperationConnection_children.min() = 0;
		BenchmarkAnalysis::meta_WorkLoadOperationConnection_children.max() = -1;
		BenchmarkAnalysis::meta_WorkLoadOperationConnection_children.isNavigable() = true;
	...
	void InitComposition26()
	{
		...
		BenchmarkCharacteristics::meta_BenchmarkAnalysis_parent.name() = "BenchmarkAnalysis_parent";
		BenchmarkCharacteristics::meta_BenchmarkAnalysis_parent.isNavigable() = true;
		...
		BenchmarkAnalysis::meta_BenchmarkCharacteristics_children.name() = "BenchmarkCharacteristics";
		BenchmarkAnalysis::meta_BenchmarkCharacteristics_children.min() = 0;
		BenchmarkAnalysis::meta_BenchmarkCharacteristics_children.max() = -1;
		BenchmarkAnalysis::meta_BenchmarkCharacteristics_children.isNavigable() = true;
	...
	void Initialize(const Uml::Diagram & dgr)
	{
		...
		Uml::SetClass(BenchmarkType::meta, umldiagram, "BenchmarkType");
		Uml::SetClass(WorkLoadOperationConnection::meta, umldiagram, "WorkLoadOperationConnection");
		Uml::SetClass(BenchmarkCharacteristics::meta, umldiagram, "BenchmarkCharacteristics");
		...
		Uml::SetClass(FixedIterationBenchmarks::meta, umldiagram, "FixedIterationBenchmarks");
		Uml::SetAttribute(FixedIterationBenchmarks::meta_benchmarkIterations,FixedIterationBenchmarks::meta, "benchmarkIterations");
		Uml::SetClass(ComponentOperation::meta, umldiagram, "ComponentOperation");
		Uml::SetClass(CompRef::meta, umldiagram, "CompRef");
		Uml::SetClass(TriggerBenchmarks::meta, umldiagram, "TriggerBenchmarks");
		Uml::SetClass(PeriodicBenchmarks::meta, umldiagram, "PeriodicBenchmarks");
