...
#define PACKAGE_DESCRIPTOR_UUID       "package/descriptor"
#define PACKAGE_IMPLEMNATION_UUID     "package/implementation"
#define PACKAGE_PACKAGE_UUID          "package/package"
                  ...
                  IMgaFCOs *selectedobjs,  long param)
{
  ...
  try
  {
    ...
    try
    {
      ...
      this->LoadPackageOptions (CUdmApp::options_);
      CUdmApp::UdmMain(&dnsCacheBackend,currentObjectCache,selectedObjectsCache,param);
      this->SavePackageOptions (CUdmApp::options_);
...
{
  GAME::Mga::Project proj (this->project_);
