...
// generated on Mon Jun 21 13:23:57 2004
...
namespace PICML {
	 ...
	 void Initialize()
	{
		...
		TopLevelPackages::meta = Uml::CreateClass();
		...
		TopLevelPackages::meta_name = Uml::CreateAttribute();
		...
		TopLevelPackageContainer::meta_TopLevelPackages_parent = Uml::CreateCompositionParentRole();
		TopLevelPackages::meta_RootFolder_parent = Uml::CreateCompositionParentRole();
		...
		TopLevelPackages::meta_TopLevelPackageContainer_children = Uml::CreateCompositionChildRole();
		...
		RootFolder::meta_TopLevelPackages_children = Uml::CreateCompositionChildRole();
		...
		Uml::InitClass(TopLevelPackages::meta, umldiagram, "TopLevelPackages", false, "Folder");
		...
		Uml::InitAttribute(TopLevelPackages::meta_name, TopLevelPackages::meta, "name", "String", false, false, 0, 1, false, "public");
		...
		}
		{
			...
			Uml::InitAssociationRole(ComponentPackage::meta_dstImplementation, ass, "dstImplementation", true, false, 0, -1, ComponentImplementationReference::meta);
		...
		}
		{
			...
			Uml::InitCompositionParentRole(TopLevelPackageContainer::meta_TopLevelPackages_parent, comp, "TopLevelPackages_parent", true, TopLevelPackages::meta);
			Uml::InitCompositionChildRole(TopLevelPackages::meta_TopLevelPackageContainer_children, comp, "TopLevelPackageContainer", true, 0, -1, TopLevelPackageContainer::meta);
		}
		{
			Uml::Composition comp = Uml::CreateComposition();
			Uml::InitComposition(comp , umldiagram, "");
		...
		}
		{
			...
			Uml::InitCompositionParentRole(TopLevelPackages::meta_RootFolder_parent, comp, "RootFolder_parent", true, RootFolder::meta);
			Uml::InitCompositionChildRole(RootFolder::meta_TopLevelPackages_children, comp, "TopLevelPackages", true, 0, -1, TopLevelPackages::meta);
		}
		{
			Uml::Composition comp = Uml::CreateComposition();
			Uml::InitComposition(comp , umldiagram, "");
