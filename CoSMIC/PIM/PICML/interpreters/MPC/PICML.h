...
// generated on Tue Jan 25 10:46:11 2005
...
namespace PICML {
	...
	class  Component :  public Manageable, public NamedType, public SupportsInterfaces {
	 public:
		static Uml::Class meta;

		Component() { }
		Component(Udm::ObjectImpl *impl) : Manageable(impl),NamedType(impl),SupportsInterfaces(impl), MgaObject(impl), Object(impl) { }
		Component(const Component &master) : Manageable(master),NamedType(master),SupportsInterfaces(master), MgaObject(master), Object(master) { }
	...
	class  Object :  public Provideable, public Prefixable, public HasOperations {
	 public:
		...
		Object() { }
		Object(Udm::ObjectImpl *impl) : Provideable(impl),Prefixable(impl),HasOperations(impl), MgaObject(impl), Object(impl) { }
		Object(const Object &master) : Provideable(master),Prefixable(master),HasOperations(master), MgaObject(master), Object(master) { }
