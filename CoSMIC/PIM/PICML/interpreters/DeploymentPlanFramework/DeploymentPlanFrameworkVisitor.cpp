...
namespace PICML
{
  ...
  {
    PICML::InstanceConnection source_connection;
    PICML::InstanceConnection dest_connection;
		    ...
		    != this->selected_instances_.end ())
      {
        if (this->selected_instances_.find (dest_comp_instance_path)
			      != this->selected_instances_.end ())
          {
            ...
            std::pair <PICML::InstanceConnection, PICML::InstanceConnection > 
    ...
    for (std::set<DeploymentPlan>::iterator iter = plans.begin();
         ...
         ++iter)
      {
        ...
        std::string plan_name = plan.name ();
		    ...
		    std::map<std::string, PICML::Component> monolith_instances;
        std::map<std::string, PICML::Component> assembly_instances;
  ...
  {
	  for (std::map<std::string, PICML::Component>::const_iterator instance_iterator =
  ...
  {
	  for (std::map<std::string,PICML::Component>::const_iterator assembly_comp_iter =
