...
MIDL_DEFINE_GUID(IID, LIBID_MgaComponentLib,0xEF065713,0xA1D1,0x49AC,0xBB,0xD4,0xFE,0x10,0xB7,0xDC,0x70,0xD7);


MIDL_DEFINE_GUID(CLSID, CLSID_MgaComponent,0xA5B6B00A,0xABB6,0x4CF0,0xB8,0xCB,0xBD,0xEC,0x1B,0x64,0xC4,0x1E);
