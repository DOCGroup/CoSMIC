...
// $Id: Sender_Two_Port_CoWorkEr.cpp,v 1.1.2.7 2006/04/19 09:29:00 hillj Exp $

#include "Sender_Two_Port_CoWorkEr.h"
#include "cuts/ActivationRecord.h"

namespace CIDL_Sender_Two_Port_Impl 
{
  Sender_Two_Port_CoWorkEr::Sender_Two_Port_CoWorkEr (void) 
  {
    Sender_Two_Port_CoWorkEr::init ();
  }

  Sender_Two_Port_CoWorkEr::~Sender_Two_Port_CoWorkEr (void) 
  {
    Sender_Two_Port_CoWorkEr::fini ();
  }

  //
  // Event Sink: input
  //
  void Sender_Two_Port_CoWorkEr::push_input (
    Dummy_Event * ev
  ...
  void Sender_Two_Port_CoWorkEr::push_input_event_handler (
  ...
  //
  void Sender_Two_Port_CoWorkEr::push_input_two (
    Dummy_Event * ev
    ACE_ENV_ARG_DECL_WITH_DEFAULTS)
  	ACE_THROW_SPEC ((::CORBA::SystemException))
  {
  ...
  void Sender_Two_Port_CoWorkEr::push_input_two_event_handler (
    CUTS_Activation_Record * record)
  {
    record->record_exit_point (
      "output_two",
  ...
  //
  void Sender_Two_Port_CoWorkEr::cuts_activate (void)
  {
  ...
  //
  void Sender_Two_Port_CoWorkEr::set_session_context (
  ...
  {
    ACE_DEBUG ((LM_TRACE,
                "entered Sender_Two_Port_CoWorkEr set_session_context\n"));
  ...
  //
  void Sender_Two_Port_CoWorkEr::ciao_preactivate (
    ACE_ENV_SINGLE_ARG_DECL_WITH_DEFAULTS)
    ACE_THROW_SPEC ((::CORBA::SystemException,
                     ::Components::CCMException))
  {
    ACE_DEBUG ((LM_TRACE,
                "entered Sender_Two_Port_CoWorkEr ciao_preactivate\n"));
  ...
  //
  void Sender_Two_Port_CoWorkEr::ccm_activate (
    ACE_ENV_SINGLE_ARG_DECL_WITH_DEFAULTS)
    ACE_THROW_SPEC ((::CORBA::SystemException,
                     ::Components::CCMException))
  {
  ...
  //
  void Sender_Two_Port_CoWorkEr::ciao_postactivate (
    ACE_ENV_SINGLE_ARG_DECL_WITH_DEFAULTS)
    ACE_THROW_SPEC ((::CORBA::SystemException,
                     ::Components::CCMException))
  {
  ...
  //
  void Sender_Two_Port_CoWorkEr::ccm_passivate (
    ACE_ENV_SINGLE_ARG_DECL_WITH_DEFAULTS)
    ACE_THROW_SPEC ((::CORBA::SystemException,
                     ::Components::CCMException))
  {
  ...
  //
  void Sender_Two_Port_CoWorkEr::ccm_remove (
    ACE_ENV_SINGLE_ARG_DECL_WITH_DEFAULTS)
    ACE_THROW_SPEC ((::CORBA::SystemException,
                     ::Components::CCMException))
  {
  ...
  // init
  //
  void Sender_Two_Port_CoWorkEr::init (void) 
  {
    ACE_DEBUG ((LM_TRACE,
                "entered Sender_Two_Port_CoWorkEr::init\n"));

    // Configuring <input> event port
    this->push_input_port_agent_.name ("input");
    this->push_input_event_handler_.bind (
      this, &this->push_input_port_agent_, &Sender_Two_Port_CoWorkEr::push_input_event_handler);
    ...
    this->push_input_two_event_handler_.bind (
      this, &this->push_input_two_port_agent_, &Sender_Two_Port_CoWorkEr::push_input_two_event_handler);
  ...
  // fini
  //
  void Sender_Two_Port_CoWorkEr::fini (void) 
  {
  ...
  Sender_Two_Port_Factory_CoWorkEr_Factory::Sender_Two_Port_Factory_CoWorkEr_Factory (void) 
  {
  ...
  Sender_Two_Port_Factory_CoWorkEr_Factory::create (ACE_ENV_SINGLE_ARG_DECL)
  ...
  create_Sender_Two_Port_Factory_CoWorkEr_Factory_Impl (void) 
  {
    ::Components::HomeExecutorBase_ptr retval =
    	::Components::HomeExecutorBase::_nil ();

    ACE_NEW_RETURN (retval, 
                    Sender_Two_Port_Factory_CoWorkEr_Factory,
                    ::Components::HomeExecutorBase::_nil ());
