...
print HEADER_FILE "#ifndef PARADIGM_HAS_DESCENDANT_PAIRS\n";
print HEADER_FILE "#define PARADIGM_HAS_DESCENDANT_PAIRS\n";
print HEADER_FILE "#endif // PARADIGM_HAS_DESCENDANT_PAIRS\n\n";
