...
set_attribute (GME::FCO & fco, const std::string & name, bool value)
{
...
inline
void T3_Runtime_Engine::
set_attribute (GME::FCO & fco, const std::string & name, long value)
{
...
inline
void T3_Runtime_Engine::
set_attribute (GME::FCO & fco, const std::string & name, double value)
{
