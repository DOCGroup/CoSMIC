...
// generated with Udm version 3.0 on Fri Jun 13 10:26:01 2008
...
namespace HFSM {
	...
	public:
		...
		template <class PeerType, class RoleType> Udm::PointerAttr<PeerType> peer() const { boost::function_requires< Udm::SuperSubclassTypelist2Concept<PeerType, RoleType, AssociationsSingle> >(); return Udm::PointerAttr<PeerType>(impl, _type2ARole<RoleType>()); }
		...
		template <class ChildType, class RoleType> Udm::ChildAttr<ChildType> child() const { boost::function_requires< Udm::SuperSubclassTypelist2Concept<ChildType, RoleType, ChildrenSingle> >(); return Udm::ChildAttr<ChildType>(impl, _type2CCRole<RoleType>()); }
		template <class ChildrenType, class RoleType> Udm::ChildrenAttr<ChildrenType> children() const { boost::function_requires< Udm::SuperSubclassTypelist2Concept<ChildrenType, RoleType, ChildrenMulti> >(); return Udm::ChildrenAttr<ChildrenType>(impl, _type2CCRole<RoleType>()); }
		...
		typedef pair< ::HFSM::RootFolder, PR_RootFolder_parent > _PR_RootFolder_parent__RootFolder;
		typedef LOKI_TYPELIST_1(_PR_RootFolder_parent__RootFolder) Parents;

		// typelist for parent by returned type relations;
		typedef LOKI_TYPELIST_1(::HFSM::RootFolder) ParentKinds;
		...
		typedef pair< ::HFSM::InputSequence, CR_InputSequence_children > _CR_InputSequence_children__InputSequence;
		typedef pair< ::HFSM::State, CR_State_children > _CR_State_children__State;
		typedef pair< ::HFSM::RootFolder, CR_RootFolder_children > _CR_RootFolder_children__RootFolder;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenSingle;
		typedef LOKI_TYPELIST_3(_CR_InputSequence_children__InputSequence, _CR_State_children__State, _CR_RootFolder_children__RootFolder) ChildrenMulti;

		// typelist for children by returned type relations;
		typedef LOKI_TYPELIST_4(::HFSM::State, ::HFSM::InputSequence, ::HFSM::RootFolder, 
			                    ::HFSM::MgaObject) ChildrenKinds;

		// types and typelist for associations by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsMulti;

		// types and typelist for associations by returned type, association class and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsWAClassSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsWAClassMulti;

		// types and typelist for cross associations by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) CrossAssociationsSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) CrossAssociationsMulti;

		// types and typelist for cross associations by returned type, association class and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) CrossAssociationsWAClassSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) CrossAssociationsWAClassMulti;

		// types and typelist for association class ends by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) AClassEnds;

		// types and typelist for cross association class by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) CrossAClassEnds;
	...
	public:
		...
		template <class ChildrenType, class Pred> Udm::ChildrenAttr<ChildrenType, Pred> children_kind_sorted() const { boost::function_requires< Udm::SuperSubclassTypelistConcept<ChildrenType, ChildrenKinds> >(); return Udm::ChildrenAttr<ChildrenType, Pred>(impl, Udm::NULLCHILDROLE); }
		template <class ParentType, class RoleType> Udm::ParentAttr<ParentType> parent() const { boost::function_requires< Udm::SuperSubclassTypelist2Concept<ParentType, RoleType, Parents> >(); return Udm::ParentAttr<ParentType>(impl, _type2CPRole<RoleType>()); }
		template <class ParentType> Udm::ParentAttr<ParentType> parent_kind() const { boost::function_requires< Udm::SuperSubclassTypelistConcept<ParentType, ParentKinds> >(); return Udm::ParentAttr<ParentType>(impl, Udm::NULLPARENTROLE); }
		...
		// types and typelist for parent by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) Parents;
		...
		// types and typelist for children by returned type and role relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenMulti;

		// typelist for children by returned type relations;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenKinds;
	...
	public:
		...
		class PR_RootFolder_parent {};
		typedef pair< ::HFSM::State, PR_State_parent > _PR_State_parent__State;
		typedef pair< ::HFSM::RootFolder, PR_RootFolder_parent > _PR_RootFolder_parent__RootFolder;
		...
		typedef pair< ::HFSM::Transition, CR_Transition_child > _CR_Transition_child__Transition;
		typedef pair< ::HFSM::State, CR_State_child > _CR_State_child__State;
		typedef LOKI_TYPELIST_2(_CR_Transition_child__Transition, _CR_State_child__State) ChildrenSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenMulti;

		// typelist for children by returned type relations;
		typedef LOKI_TYPELIST_3(::HFSM::State, ::HFSM::Transition, ::HFSM::MgaObject) ChildrenKinds;
		...
		typedef pair< ::HFSM::State, pair< ::HFSM::Transition, AR_srcTransition > > _AR_srcTransition__Transition__State;
		typedef pair< ::HFSM::State, pair< ::HFSM::Transition, AR_dstTransition > > _AR_dstTransition__Transition__State;
		typedef LOKI_TYPELIST_2(_AR_srcTransition__Transition__State, _AR_dstTransition__Transition__State) AssociationsWAClassSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsWAClassMulti;
	...
	public:
		...
		class PR_State_parent {};
		typedef pair< ::HFSM::State, PR_State_parent > _PR_State_parent__State;
		typedef LOKI_TYPELIST_1(_PR_State_parent__State) Parents;

		// typelist for parent by returned type relations;
		typedef LOKI_TYPELIST_1(::HFSM::MgaObject) ParentKinds;
		...
		typedef pair< ::HFSM::State, ACE_dstTransition > _ACE_dstTransition__State;
		typedef pair< ::HFSM::State, ACE_srcTransition > _ACE_srcTransition__State;
		typedef LOKI_TYPELIST_2(_ACE_dstTransition__State, _ACE_srcTransition__State) AClassEnds;
	...
	public:
		...
		typedef pair< ::HFSM::InputSequence, PR_InputSequence_parent > _PR_InputSequence_parent__InputSequence;
		typedef LOKI_TYPELIST_1(_PR_InputSequence_parent__InputSequence) Parents;
		...
		typedef pair< ::HFSM::Events, pair< ::HFSM::Sequence, AR_srcSequence > > _AR_srcSequence__Sequence__Events;
		typedef pair< ::HFSM::Events, pair< ::HFSM::Sequence, AR_dstSequence > > _AR_dstSequence__Sequence__Events;
		typedef LOKI_TYPELIST_2(_AR_srcSequence__Sequence__Events, _AR_dstSequence__Sequence__Events) AssociationsWAClassSingle;
		typedef LOKI_TYPELIST_1(Loki::NullType) AssociationsWAClassMulti;
	...
	public:
		...
		typedef pair< ::HFSM::Events, CR_Events_children > _CR_Events_children__Events;
		typedef pair< ::HFSM::Sequence, CR_Sequence_children > _CR_Sequence_children__Sequence;
		typedef LOKI_TYPELIST_1(Loki::NullType) ChildrenSingle;
		typedef LOKI_TYPELIST_2(_CR_Events_children__Events, _CR_Sequence_children__Sequence) ChildrenMulti;

		// typelist for children by returned type relations;
		typedef LOKI_TYPELIST_3(::HFSM::Events, ::HFSM::Sequence, ::HFSM::MgaObject) ChildrenKinds;
	...
	public:
		...
		Udm::AssocEndAttr< ::HFSM::Events> dstSequence_end() const 
		{ 
			return Udm::AssocEndAttr< ::HFSM::Events>(impl, meta_dstSequence_end_); 
		}
		...
		typedef pair< ::HFSM::Events, ACE_dstSequence > _ACE_dstSequence__Events;
		typedef pair< ::HFSM::Events, ACE_srcSequence > _ACE_srcSequence__Events;
		typedef LOKI_TYPELIST_2(_ACE_dstSequence__Events, _ACE_srcSequence__Events) AClassEnds;
