...
// generated with Udm version 3.13 on Tue Apr 07 14:55:15 2009
...
namespace HFSM {
	...
	public:
		...
		virtual void Visit_FinalStateRef(const FinalStateRef &) {}
	...
	public:
		...
		typedef boost::mpl::vector< ::HFSM::StateMachine, ::HFSM::RootFolder, ::HFSM::InputSequence> ChildrenKinds;
	...
	public:
		...
		template <class EndType, class RoleType> Udm::AssocEndAttr<EndType> end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, AClassEnds> >(); return Udm::AssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		template <class EndType, class RoleType> Udm::CrossAssocEndAttr<EndType> cross_end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, CrossAClassEnds> >(); return Udm::CrossAssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState> srcTransition() const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState>(impl, meta_srcTransition, meta_srcTransition_rev); }
		template <class Pred> Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState, Pred> srcTransition_sorted(const Pred &) const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState, Pred>(impl, meta_srcTransition, meta_srcTransition_rev); }
		Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState> dstTransition() const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState>(impl, meta_dstTransition, meta_dstTransition_rev); }
		template <class Pred> Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState, Pred> dstTransition_sorted(const Pred &) const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::BaseState, Pred>(impl, meta_dstTransition, meta_dstTransition_rev); }
		Udm::ParentAttr< ::HFSM::FinalState> FinalState_parent() const { return Udm::ParentAttr< ::HFSM::FinalState>(impl, meta_FinalState_parent); }
		Udm::ParentAttr< ::HFSM::StartState> StartState_parent() const { return Udm::ParentAttr< ::HFSM::StartState>(impl, meta_StartState_parent); }
		...
		static ::Uml::CompositionParentRole meta_FinalState_parent;
		static ::Uml::CompositionParentRole meta_StartState_parent;
		static ::Uml::CompositionParentRole meta_StateMachine_parent;
		static ::Uml::CompositionParentRole meta_State_parent;

		// types and typelist for parent by returned type and role relations;
		class PR_FinalState_parent {};
		class PR_StartState_parent {};
		class PR_StateMachine_parent {};
		class PR_State_parent {};
		typedef boost::mpl::pair< ::HFSM::FinalState, PR_FinalState_parent > _PR_FinalState_parent__FinalState;
		typedef boost::mpl::pair< ::HFSM::StartState, PR_StartState_parent > _PR_StartState_parent__StartState;
		...
		typedef boost::mpl::vector< _PR_FinalState_parent__FinalState, _PR_StartState_parent__StartState, _PR_StateMachine_parent__StateMachine, _PR_State_parent__State> Parents;

		// typelist for parent by returned type relations;
		typedef boost::mpl::vector< ::HFSM::StartState, ::HFSM::FinalState, ::HFSM::StateMachine, ::HFSM::State> ParentKinds;
		...
		typedef boost::mpl::vector< > AssociationsWAClassSingle;
		typedef boost::mpl::vector< _AR_srcTransition__Transition__BaseState, _AR_dstTransition__Transition__BaseState> AssociationsWAClassMulti;
	...
	class FinalStateRef :  public BaseState {
	public:
		typedef ::Udm::ReferenceMetaTag MetaKind;

		FinalStateRef() {}
		FinalStateRef(Udm::ObjectImpl *impl) : BaseState(impl) {}
		FinalStateRef(const FinalStateRef &master) : BaseState(master) {}

		static FinalStateRef Cast(const Udm::Object &a) { return __Cast(a, meta); }
		static FinalStateRef Create(const Udm::Object &parent, const ::Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role); }
		FinalStateRef CreateInstance(const Udm::Object &parent, const ::Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl); }
		Udm::InstantiatedAttr<FinalStateRef> Instances() { return Udm::InstantiatedAttr<FinalStateRef>(impl); }
		template <class Pred> Udm::InstantiatedAttr<FinalStateRef, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<FinalStateRef, Pred>(impl); }
		FinalStateRef CreateDerived(const Udm::Object &parent, const ::Uml::CompositionChildRole &role = Udm::NULLCHILDROLE) { return __Create(meta, parent, role, impl); }
		Udm::DerivedAttr<FinalStateRef> Derived() { return Udm::DerivedAttr<FinalStateRef>(impl); }
		template <class Pred> Udm::DerivedAttr<FinalStateRef, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<FinalStateRef, Pred>(impl); }
		Udm::ArchetypeAttr<FinalStateRef> Archetype() const { return Udm::ArchetypeAttr<FinalStateRef>(impl); }
		template <typename T> const ::Uml::AssociationRole& _type2ARole() const;
		template <typename T> const pair<const ::Uml::AssociationRole*, const ::Uml::AssociationRole*> _type2ACARole() const;
		template <typename T> const ::Uml::CompositionParentRole& _type2CPRole() const;
		template <typename T> const ::Uml::CompositionChildRole& _type2CCRole() const;
    ...
    { 
      ...
      return Udm::ChildrenAttr<ChildrenType>(impl, Udm::NULLCHILDROLE); 
		...
		template <class EndType, class RoleType> Udm::AssocEndAttr<EndType> end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, AClassEnds> >(); return Udm::AssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		template <class EndType, class RoleType> Udm::CrossAssocEndAttr<EndType> cross_end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, CrossAClassEnds> >(); return Udm::CrossAssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		Udm::PointerAttr< ::HFSM::FinalState> ref() const { return Udm::PointerAttr< ::HFSM::FinalState>(impl, meta_ref); }
		Udm::ParentAttr< ::HFSM::MgaObject> parent() const { return Udm::ParentAttr< ::HFSM::MgaObject>(impl, Udm::NULLPARENTROLE); }
		void Accept(Visitor &v) { v.Visit_FinalStateRef(*this); }
		...
		// types and typelist for associations by returned type and role relations;
		class AR_ref {};
		typedef boost::mpl::pair< ::HFSM::FinalState, AR_ref > _AR_ref__FinalState;
		typedef boost::mpl::vector< _AR_ref__FinalState> AssociationsSingle;
		typedef boost::mpl::vector< > AssociationsMulti;
	...
	public:
		...
		// typelist for parent by returned type relations;
		typedef boost::mpl::vector< ::HFSM::StateMachine> ParentKinds;
	...
	public:
		...
		Udm::ChildrenAttr< ::HFSM::FinalStateRef> FinalStateRef_kind_children() const { return Udm::ChildrenAttr< ::HFSM::FinalStateRef>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::FinalStateRef, Pred> FinalStateRef_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::FinalStateRef, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		// typelist for children by returned type relations;
		typedef boost::mpl::vector< ::HFSM::BaseState> ChildrenKinds;
	...
	public:
		...
		template <class EndType, class RoleType> Udm::AssocEndAttr<EndType> end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, AClassEnds> >(); return Udm::AssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		template <class EndType, class RoleType> Udm::CrossAssocEndAttr<EndType> cross_end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, CrossAClassEnds> >(); return Udm::CrossAssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		Udm::AssocAttr< ::HFSM::FinalStateRef> referedbyFinalStateRef() const { return Udm::AssocAttr< ::HFSM::FinalStateRef>(impl, meta_referedbyFinalStateRef); }
		template <class Pred> Udm::AssocAttr< ::HFSM::FinalStateRef, Pred> referedbyFinalStateRef_sorted(const Pred &) const { return Udm::AssocAttr< ::HFSM::FinalStateRef, Pred>(impl, meta_referedbyFinalStateRef); }
		Udm::ChildrenAttr< ::HFSM::BaseState> BaseState_children() const { return Udm::ChildrenAttr< ::HFSM::BaseState>(impl, meta_BaseState_children); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::BaseState, Pred> BaseState_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::BaseState, Pred>(impl, meta_BaseState_children); }
		Udm::ChildrenAttr< ::HFSM::BaseState> BaseState_kind_children() const { return Udm::ChildrenAttr< ::HFSM::BaseState>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::BaseState, Pred> BaseState_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::BaseState, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		static ::Uml::Class meta;
		static ::Uml::AssociationRole meta_referedbyFinalStateRef;
		static ::Uml::CompositionChildRole meta_BaseState_children;
		...
		// types and typelist for associations by returned type and role relations;
		class AR_referedbyFinalStateRef {};
		typedef boost::mpl::pair< ::HFSM::FinalStateRef, AR_referedbyFinalStateRef > _AR_referedbyFinalStateRef__FinalStateRef;
		typedef boost::mpl::vector< > AssociationsSingle;
		typedef boost::mpl::vector< _AR_referedbyFinalStateRef__FinalStateRef> AssociationsMulti;
    ...
    Udm::ChildrenAttr< ::HFSM::BaseState> 
    BaseState_kind_children() const 
    { 
      return Udm::ChildrenAttr< ::HFSM::BaseState>(impl, Udm::NULLCHILDROLE); 
    }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::BaseState, Pred> BaseState_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::BaseState, Pred>(impl, Udm::NULLCHILDROLE); }
		Udm::ChildrenAttr< ::HFSM::FinalStateRef> FinalStateRef_kind_children() const { return Udm::ChildrenAttr< ::HFSM::FinalStateRef>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::FinalStateRef, Pred> FinalStateRef_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::FinalStateRef, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		Udm::ChildrenAttr< ::HFSM::StartState> StartState_kind_children() const { return Udm::ChildrenAttr< ::HFSM::StartState>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::StartState, Pred> StartState_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::StartState, Pred>(impl, Udm::NULLCHILDROLE); }
		Udm::ChildrenAttr< ::HFSM::FinalState> 
    FinalState_kind_children() const 
    { 
      return Udm::ChildrenAttr< ::HFSM::FinalState>(impl, Udm::NULLCHILDROLE); 
    }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::FinalState, Pred> FinalState_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::FinalState, Pred>(impl, Udm::NULLCHILDROLE); }
		Udm::ChildrenAttr< ::HFSM::State> State_kind_children() const { return Udm::ChildrenAttr< ::HFSM::State>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::State, Pred> State_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::State, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		// typelist for children by returned type relations;
		typedef boost::mpl::vector< ::HFSM::BaseState, ::HFSM::Transition> ChildrenKinds;
