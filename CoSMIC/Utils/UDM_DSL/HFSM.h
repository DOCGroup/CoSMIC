...
// generated with Udm version 3.0 on Thu Oct 02 10:20:50 2008
...
namespace HFSM {
	...
	public:
		...
		typedef boost::mpl::vector< _CR_InputSequence_children__InputSequence, _CR_State_children__State, _CR_RootFolder_children__RootFolder> ChildrenMulti;

		// typelist for children by returned type relations;
		typedef boost::mpl::vector< ::HFSM::State, ::HFSM::InputSequence, ::HFSM::RootFolder> ChildrenKinds;
	...
	public:
		...
		// typelist for children by returned type relations;
		typedef boost::mpl::vector< ::HFSM::Transition, ::HFSM::State> ChildrenKinds;
