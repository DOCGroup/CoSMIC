...
// generated with Udm version 3.13 on Sat Apr 25 19:10:47 2009
...
namespace HFSM {
	...
	public:
		...
		typedef boost::mpl::vector< _CR_StateMachine_children__StateMachine, _CR_InputSequence_children__InputSequence> ChildrenMulti;
	...
	public:
		...
		template <class EndType, class RoleType> Udm::AssocEndAttr<EndType> end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, AClassEnds> >(); return Udm::AssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		template <class EndType, class RoleType> Udm::CrossAssocEndAttr<EndType> cross_end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, CrossAClassEnds> >(); return Udm::CrossAssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State> dstTransition() const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State>(impl, meta_dstTransition, meta_dstTransition_rev); }
		template <class Pred> Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State, Pred> dstTransition_sorted(const Pred &) const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State, Pred>(impl, meta_dstTransition, meta_dstTransition_rev); }
		Udm::AssocAttr< ::HFSM::Reference> referedbyReference() const { return Udm::AssocAttr< ::HFSM::Reference>(impl, meta_referedbyReference); }
		template <class Pred> Udm::AssocAttr< ::HFSM::Reference, Pred> referedbyReference_sorted(const Pred &) const { return Udm::AssocAttr< ::HFSM::Reference, Pred>(impl, meta_referedbyReference); }
		Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State> srcTransition() const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State>(impl, meta_srcTransition, meta_srcTransition_rev); }
		template <class Pred> Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State, Pred> srcTransition_sorted(const Pred &) const { return Udm::AClassAssocAttr< ::HFSM::Transition, ::HFSM::State, Pred>(impl, meta_srcTransition, meta_srcTransition_rev); }
		...
		Udm::ChildrenAttr< ::HFSM::Reference> Reference_children() const { return Udm::ChildrenAttr< ::HFSM::Reference>(impl, meta_Reference_children); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::Reference, Pred> Reference_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::Reference, Pred>(impl, meta_Reference_children); }
		...
		Udm::ChildrenAttr< ::HFSM::Reference> Reference_kind_children() const { return Udm::ChildrenAttr< ::HFSM::Reference>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::Reference, Pred> Reference_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::Reference, Pred>(impl, Udm::NULLCHILDROLE); }
		Udm::ChildrenAttr< ::HFSM::MgaObject> MgaObject_kind_children() const { return Udm::ChildrenAttr< ::HFSM::MgaObject>(impl, Udm::NULLCHILDROLE); }
		template <class Pred> Udm::ChildrenAttr< ::HFSM::MgaObject, Pred> MgaObject_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr< ::HFSM::MgaObject, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		typedef boost::mpl::vector< _PR_State_parent__State, _PR_StateMachine_parent__StateMachine> Parents;

		// typelist for parent by returned type relations;
		typedef boost::mpl::vector< ::HFSM::State, ::HFSM::StateMachine> ParentKinds;
		...
		typedef boost::mpl::pair< ::HFSM::Reference, CR_Reference_children > _CR_Reference_children__Reference;
		typedef boost::mpl::vector< > ChildrenSingle;
		typedef boost::mpl::vector< _CR_State_children__State, _CR_Reference_children__Reference> ChildrenMulti;
		...
		typedef boost::mpl::pair< ::HFSM::Reference, AR_referedbyReference > _AR_referedbyReference__Reference;
		typedef boost::mpl::vector< > AssociationsSingle;
		...
		typedef boost::mpl::vector< > AssociationsWAClassSingle;
		typedef boost::mpl::vector< _AR_dstTransition__Transition__State, _AR_srcTransition__Transition__State> AssociationsWAClassMulti;
	...
	public:
		...
		template <class EndType, class RoleType> Udm::AssocEndAttr<EndType> end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, AClassEnds> >(); return Udm::AssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		template <class EndType, class RoleType> Udm::CrossAssocEndAttr<EndType> cross_end() const { boost::function_requires< Udm::WithRoleInTListConcept<EndType, RoleType, CrossAClassEnds> >(); return Udm::CrossAssocEndAttr<EndType>(impl, _type2ARole<RoleType>()); }
		Udm::PointerAttr< ::HFSM::State> ref() const { return Udm::PointerAttr< ::HFSM::State>(impl, meta_ref); }
		Udm::ParentAttr< ::HFSM::State> State_parent() const { return Udm::ParentAttr< ::HFSM::State>(impl, meta_State_parent); }
		Udm::ParentAttr< ::HFSM::StateMachine> StateMachine_parent() const { return Udm::ParentAttr< ::HFSM::StateMachine>(impl, meta_StateMachine_parent); }
		Udm::ParentAttr< ::HFSM::MgaObject> parent() const { return Udm::ParentAttr< ::HFSM::MgaObject>(impl, Udm::NULLPARENTROLE); }
		...
		// types and typelist for associations by returned type and role relations;
		class AR_ref {};
		typedef boost::mpl::pair< ::HFSM::State, AR_ref > _AR_ref__State;
		typedef boost::mpl::vector< _AR_ref__State> AssociationsSingle;
		typedef boost::mpl::vector< > AssociationsMulti;
	...
	public:
		...
		typedef boost::mpl::vector< _ACE_srcTransition__State, _ACE_dstTransition__State> AClassEnds;
	...
	public:
		...
		typedef boost::mpl::vector< > ChildrenSingle;
		typedef boost::mpl::vector< _CR_Reference_children__Reference, _CR_State_children__State, _CR_Transition_children__Transition> ChildrenMulti;
