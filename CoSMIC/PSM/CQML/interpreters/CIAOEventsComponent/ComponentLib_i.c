...
MIDL_DEFINE_GUID(IID, IID_IMgaXslt,0xFDE29236,0x8F66,0x489d,0xAE,0x5A,0xCC,0x78,0x9A,0x6E,0x51,0xD6);


MIDL_DEFINE_GUID(IID, LIBID_MgaComponentLib,0xACFF4832,0xE280,0x4750,0xBF,0xB8,0xA6,0x0C,0x81,0x9F,0x7A,0x7F);


MIDL_DEFINE_GUID(CLSID, CLSID_MgaComponent,0x73334395,0x0002,0x4FEC,0x80,0xFA,0xC0,0xBA,0x28,0x40,0x74,0xCB);
