...
#include "CQML/CQML.h"
#include "BIRSpecification/BIRSpecificationVisitor.h"
      ...
      try
        {
		  ...
		  CQML::BIRSpecificationVisitor visitor (outputPath);
          CQML::RootFolder
        ...
        {
          AfxMessageBox ("BIRSpecification Interpretation Failed. Caught UDM Exception: "
                         + CString (e.what()));
          return;
        }
