...
namespace CQML 
  {
    ...
    void RTSchedulabilityDumper::dumpInterfaceRights (Interface2Operations2RightsMap& iface2op2rts_map)
      {
    ...
    void RTSchedulabilityDumper::dumpRoleRights (Role2RightsMap& role2rights_map)
      {
        std::string name = this->outputPath_ + "\\";
    ...
    void RTSchedulabilityDumper::dumpPolicies (PoliciesMap& policies_map)
      {
        std::string name = this->outputPath_ + "\\";
    ...
    void RTSchedulabilityDumper::generateRule (Rule &rule)
      {
    ...
    void RTSchedulabilityDumper::generatePortRule (Rule& rule)
      {
    ...
    void RTSchedulabilityDumper::generateComponentRule (Rule& rule)
      {
    ...
    void RTSchedulabilityDumper::generateAssemblyRule (Rule& rule)
      {
    ...
    std::string RTSchedulabilityDumper::getRightsString (const CQML::Rights& rights)
      {
    ...
    void RTSchedulabilityDumper::dumpPermissions (const SecurityQoSRequirements& secqos_req)
      {
