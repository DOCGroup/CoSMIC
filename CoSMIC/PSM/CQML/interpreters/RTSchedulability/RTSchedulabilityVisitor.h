// $Id: RTSchedulabilityVisitor.h 587 2005-12-14 21:39:34Z sutambe $
...
namespace CQML
{
  class SecurityQoS_Export RTSchedulabilityVisitor: public Visitor
  {
  public:
    RTSchedulabilityVisitor (const std::string& outputPath);
    
    // Helpers
    void populateObj2Op2RightsMap(CQML::Object object);
    void populatePoliciesMap(CQML::Policy policy);
  ...
  private:
    ...
    RTSchedulabilityDumper secqos_dumper_;
