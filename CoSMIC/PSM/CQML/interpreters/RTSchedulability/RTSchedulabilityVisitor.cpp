...
#include <functional>
#include <sstream>
#include "RTSchedulability/RTSchedulabilityVisitor.h"
...
namespace CQML
  {
    ...
    */ 
    ...
    void RTSchedulabilityVisitor::Visit_TwowayOperation(const TwowayOperation& twowyop)
      {
        this->populate_operation_set <TwowayOperation> (twowyop);
      }
    
    void RTSchedulabilityVisitor::Visit_OnewayOperation(const OnewayOperation& onewyop)
      {
        this->populate_operation_set <OnewayOperation> (onewyop);
      }
    
    void RTSchedulabilityVisitor::Visit_FactoryOperation(const FactoryOperation& factoryop)
      {
        this->populate_operation_set <FactoryOperation> (factoryop);
      }
    
    void RTSchedulabilityVisitor::Visit_LookupOperation(const LookupOperation& lookupop)
      {
        this->populate_operation_set <LookupOperation> (lookupop);
      }


    inline void RTSchedulabilityVisitor::populateObj2Op2RightsMap(CQML::Object object)
      {
        // cleanup
    ...
    void RTSchedulabilityVisitor::Visit_Security(const Security& security)
      {
    ...
    void RTSchedulabilityVisitor::Visit_RBAC(const RBAC& rbac)
      {
		    // e.g. cuts/CUTS
    ...
    /////////////////////////////////////////////////////////////////////////////////////////
    void RTSchedulabilityVisitor::Visit_PolicySet(const PolicySet& policyset)
      {
        accept_each_child (policyset, Policy, *this)
      }
    

    void RTSchedulabilityVisitor::Visit_Policy(const Policy& policy)
      {
    ...
    void RTSchedulabilityVisitor::Visit_PortRule(const PortRule& port_rule)
      {
        Rule rule;
    ...
    void RTSchedulabilityVisitor::Visit_ComponentRule(const ComponentRule& comp_rule)
      {
        Rule rule;
    ...
    void RTSchedulabilityVisitor::Visit_AssemblyRule(const AssemblyRule& assm_rule)
      {
        Rule rule;
    ...
    inline void RTSchedulabilityVisitor::populatePoliciesMap(Policy policy)
      {
        // cleanup
        // Insert this interface and the populated operation set
    ...
    void RTSchedulabilityVisitor::Visit_PortSecurityQoS(const PortSecurityQoS& port_sec_qos)
      {
    ...
    void RTSchedulabilityVisitor::Visit_ComponentSecurityQoS(const ComponentSecurityQoS& comp_sec_qos)
      {
        // make sure its clear
        this->rule_set_.clear();        
    ...
    void RTSchedulabilityVisitor::Visit_ComponentAssemblySecurityQoS(const ComponentAssemblySecurityQoS& assm_sec_qos)
      {
        // make sure its clear
        this->rule_set_.clear();
    ...
    void RTSchedulabilityVisitor::Visit_CriticalPath (const CriticalPath& cpath)
    {
    ...
    void RTSchedulabilityVisitor::Visit_PathReference (const PathReference& pref)
    {
      Path criticalpath = pref.ref();
      criticalpath.Accept (*this);
    }

    void RTSchedulabilityVisitor::Visit_Path (const Path& path)
    {
...
/*      this->push();
    ...
    */
    ...
    std::string RTSchedulabilityVisitor::CreatePath (const DisplayNode& node)
    {
    ...
    std::string RTSchedulabilityVisitor::ExtractName(Udm::Object ob)
    {
