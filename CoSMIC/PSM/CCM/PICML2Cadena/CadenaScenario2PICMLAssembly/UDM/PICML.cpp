...
// generated on Fri Jun 18 06:06:55 2004
...
namespace PICML {
	 ...
	 void Initialize()
	{
		...
		}
		{
			...
			ComponentPackage::meta_dstImplementation.min() = 1;
		...
		Property::meta_cadenaProperty = PICMLAssembly2CadenaScenario::Property_cross_ph_PICML::meta_cadenaProperty;
		invoke::meta_cadenaInvoke = PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML::meta_cadenaInvoke;
		emit::meta_cadenaEmit = PICMLAssembly2CadenaScenario::emit_cross_ph_PICML::meta_cadenaEmit;
		ComponentAssembly::meta_rootContainer = PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML::meta_rootContainer;
		ComponentAssembly::meta_cadenaScenario = PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML::meta_cadenaScenario;
		PublishConnector::meta_cadenaESSConnection = PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML::meta_cadenaESSConnection;
		Port::meta_cadenaPort = PICMLAssembly2CadenaScenario::Port_cross_ph_PICML::meta_cadenaPort;
		Component::meta_cadenaComponentInstance = PICMLAssembly2CadenaScenario::Component_cross_ph_PICML::meta_cadenaComponentInstance;
		{
	...
	void Initialize(const Uml::Diagram & dgr)
	{
		...
		Uml::SetParentRole(TopLevelPackageFolder::meta_RootFolder_parent,TopLevelPackageFolder::meta,RootFolder::meta, "");
		Uml::SetParentRole(TopLevelPackageContainer::meta_TopLevelPackageFolder_parent,TopLevelPackageContainer::meta,TopLevelPackageFolder::meta, "");
		...
		Uml::SetChildRole(TopLevelPackageFolder::meta_TopLevelPackageContainer_children,TopLevelPackageFolder::meta,TopLevelPackageContainer::meta, "");
		...
		Uml::SetChildRole(RootFolder::meta_TopLevelPackageFolder_children,RootFolder::meta,TopLevelPackageFolder::meta, "");
		...
		Uml::SetAssocRole(ImplementationRequirement::meta_srcMonolithDeployRequirement,MonolithicImplementation::meta,MonolithicImplementation::meta, "dstMonolithDeployRequirement");
		...
		Uml::SetAssocRole(ImplementationDependency::meta_srcImplementationDependsOn,ComponentImplementation::meta,ComponentImplementation::meta, "dstImplementationDependsOn");
		ComponentImplementation::meta_dstImplementationDependsOn_rev = ImplementationDependency::meta_srcImplementationDependsOn;

		Uml::SetAssocRole(Capability::meta_srcImplementationCapability,ComponentImplementation::meta,ComponentImplementation::meta, "dstImplementationCapability");
		ComponentImplementation::meta_dstImplementationCapability_rev = Capability::meta_srcImplementationCapability;

		Uml::SetAssocRole(Property::meta_srcPackageConfigProperty,ComponentPackage::meta,ComponentPackage::meta, "dstPackageConfigProperty");
		ComponentPackage::meta_dstPackageConfigProperty_rev = Property::meta_srcPackageConfigProperty;
		Uml::SetAssocRole(Property::meta_srcPackageInfoProperty,ComponentPackage::meta,ComponentPackage::meta, "dstPackageInfoProperty");
		ComponentPackage::meta_dstPackageInfoProperty_rev = Property::meta_srcPackageInfoProperty;
		Uml::SetAssocRole(Property::meta_srcConfigProperty,ComponentImplementation::meta,ComponentImplementation::meta, "dstConfigProperty");
		ComponentImplementation::meta_dstConfigProperty_rev = Property::meta_srcConfigProperty;
		Uml::SetAssocRole(Property::meta_srcInfoProperty,ComponentImplementation::meta,ComponentImplementation::meta, "dstInfoProperty");
		ComponentImplementation::meta_dstInfoProperty_rev = Property::meta_srcInfoProperty;
		Uml::SetAssocRole(Property::meta_srcMonolithExecParameter,MonolithicImplementation::meta,MonolithicImplementation::meta, "dstMonolithExecParameter");
		MonolithicImplementation::meta_dstMonolithExecParameter_rev = Property::meta_srcMonolithExecParameter;
		Uml::SetAssocRole(Property::meta_srcComponentConfigProperty,ComponentType::meta,ComponentType::meta, "dstComponentConfigProperty");
		ComponentType::meta_dstComponentConfigProperty_rev = Property::meta_srcComponentConfigProperty;
		Uml::SetAssocRole(Property::meta_srcComponentInfoProperty,ComponentType::meta,ComponentType::meta, "dstComponentInfoProperty");
		ComponentType::meta_dstComponentInfoProperty_rev = Property::meta_srcComponentInfoProperty;
		Uml::SetAssocRole(Property::meta_srcPackageConfConfigProperty,PackageConfiguration::meta,PackageConfiguration::meta, "dstPackageConfConfigProperty");
		PackageConfiguration::meta_dstPackageConfConfigProperty_rev = Property::meta_srcPackageConfConfigProperty;
		Uml::SetAssocRole(Property::meta_srcArtifactInfoProperty,ImplementationArtifact::meta,ImplementationArtifact::meta, "dstArtifactInfoProperty");
		ImplementationArtifact::meta_dstArtifactInfoProperty_rev = Property::meta_srcArtifactInfoProperty;
		Uml::SetAssocRole(Property::meta_srcArtifactExecParameter,ImplementationArtifact::meta,ImplementationArtifact::meta, "dstArtifactExecParameter");
		ImplementationArtifact::meta_dstArtifactExecParameter_rev = Property::meta_srcArtifactExecParameter;
		Uml::SetAssocRole(Property::meta_srcAssemblyConfigProperty,Component::meta,Component::meta, "dstAssemblyConfigProperty");
		Component::meta_dstAssemblyConfigProperty_rev = Property::meta_srcAssemblyConfigProperty;

		Uml::SetAssocRole(DataType::meta_ref,PredefinedType::meta,PredefinedType::meta, "referedbyDataType");

		Uml::SetAssocRole(Requirement::meta_srcPackageConfSelectRequirement,PackageConfiguration::meta,PackageConfiguration::meta, "dstPackageConfSelectRequirement");
		PackageConfiguration::meta_dstPackageConfSelectRequirement_rev = Requirement::meta_srcPackageConfSelectRequirement;
		Uml::SetAssocRole(Requirement::meta_srcAssemblyDeployRequirement,PublishConnector::meta,PublishConnector::meta, "dstAssemblyDeployRequirement");
		PublishConnector::meta_dstAssemblyDeployRequirement_rev = Requirement::meta_srcAssemblyDeployRequirement;
		Uml::SetAssocRole(Requirement::meta_srcArtifactDeployRequirement,ImplementationArtifact::meta,ImplementationArtifact::meta, "dstArtifactDeployRequirement");
		ImplementationArtifact::meta_dstArtifactDeployRequirement_rev = Requirement::meta_srcArtifactDeployRequirement;
		Uml::SetAssocRole(Requirement::meta_srcAssemblyselectRequirement,Component::meta,Component::meta, "dstAssemblyselectRequirement");
		...
		Uml::SetAssocRole(PublishConnector::meta_dstAssemblyDeployRequirement,Requirement::meta,Requirement::meta, "srcAssemblyDeployRequirement");
		Requirement::meta_srcAssemblyDeployRequirement_rev = PublishConnector::meta_dstAssemblyDeployRequirement;
		Uml::SetAssocRole(PublishConnector::meta_dstdeliverTo,InEventPort::meta,InEventPort::meta, "srcdeliverTo");
		InEventPort::meta_srcdeliverTo_rev = PublishConnector::meta_dstdeliverTo;
		Uml::SetAssocRole(PublishConnector::meta_srcpublish,OutEventPort::meta,OutEventPort::meta, "dstpublish");
		...
		Uml::SetAssocRole(TopLevelPackage::meta_dstpackage,PackageConfigurationReference::meta,PackageConfigurationReference::meta, "srcpackage");
		PackageConfigurationReference::meta_srcpackage_rev = TopLevelPackage::meta_dstpackage;

		Uml::SetAssocRole(ComponentPackage::meta_dstPackageConfigProperty,Property::meta,Property::meta, "srcPackageConfigProperty");
		Property::meta_srcPackageConfigProperty_rev = ComponentPackage::meta_dstPackageConfigProperty;
		Uml::SetAssocRole(ComponentPackage::meta_dstPackageInfoProperty,Property::meta,Property::meta, "srcPackageInfoProperty");
		Property::meta_srcPackageInfoProperty_rev = ComponentPackage::meta_dstPackageInfoProperty;
		Uml::SetAssocRole(ComponentPackage::meta_dstPackageInterface,ComponentType::meta,ComponentType::meta, "srcPackageInterface");
		ComponentType::meta_srcPackageInterface_rev = ComponentPackage::meta_dstPackageInterface;
		Uml::SetAssocRole(ComponentPackage::meta_dstImplementation,ComponentImplementationReference::meta,ComponentImplementationReference::meta, "srcImplementation");
		ComponentImplementationReference::meta_srcImplementation_rev = ComponentPackage::meta_dstImplementation;
		Uml::SetAssocRole(ComponentPackage::meta_referedbyComponentPackageReference,ComponentPackageReference::meta,ComponentPackageReference::meta, "ref");
		Uml::SetAssocRole(ComponentPackage::meta_srcPackageConfBasePackage,PackageConfiguration::meta,PackageConfiguration::meta, "dstPackageConfBasePackage");
		PackageConfiguration::meta_dstPackageConfBasePackage_rev = ComponentPackage::meta_srcPackageConfBasePackage;


		Uml::SetAssocRole(ComponentPackageReference::meta_ref,ComponentPackage::meta,ComponentPackage::meta, "referedbyComponentPackageReference");
		Uml::SetAssocRole(ComponentPackageReference::meta_srcPackageConfReference,PackageConfiguration::meta,PackageConfiguration::meta, "dstPackageConfReference");
		...
		Uml::SetAssocRole(ComponentImplementation::meta_dstImplementationDependsOn,ImplementationDependency::meta,ImplementationDependency::meta, "srcImplementationDependsOn");
		ImplementationDependency::meta_srcImplementationDependsOn_rev = ComponentImplementation::meta_dstImplementationDependsOn;
		Uml::SetAssocRole(ComponentImplementation::meta_dstImplementationCapability,Capability::meta,Capability::meta, "srcImplementationCapability");
		Capability::meta_srcImplementationCapability_rev = ComponentImplementation::meta_dstImplementationCapability;
		Uml::SetAssocRole(ComponentImplementation::meta_dstConfigProperty,Property::meta,Property::meta, "srcConfigProperty");
		Property::meta_srcConfigProperty_rev = ComponentImplementation::meta_dstConfigProperty;
		Uml::SetAssocRole(ComponentImplementation::meta_dstInfoProperty,Property::meta,Property::meta, "srcInfoProperty");
		Property::meta_srcInfoProperty_rev = ComponentImplementation::meta_dstInfoProperty;
		Uml::SetAssocRole(ComponentImplementation::meta_dstImplements,ComponentType::meta,ComponentType::meta, "srcImplements");
		ComponentType::meta_srcImplements_rev = ComponentImplementation::meta_dstImplements;
		Uml::SetAssocRole(ComponentImplementation::meta_referedbyComponentImplementationReference,ComponentImplementationReference::meta,ComponentImplementationReference::meta, "ref");

		Uml::SetAssocRole(ComponentImplementationReference::meta_ref,ComponentImplementation::meta,ComponentImplementation::meta, "referedbyComponentImplementationReference");
		Uml::SetAssocRole(ComponentImplementationReference::meta_srcImplementation,ComponentPackage::meta,ComponentPackage::meta, "dstImplementation");
		...
		Uml::SetAssocRole(MonolithicImplementation::meta_dstMonolithDeployRequirement,ImplementationRequirement::meta,ImplementationRequirement::meta, "srcMonolithDeployRequirement");
		...
		Uml::SetAssocRole(MonolithicImplementation::meta_dstMonolithExecParameter,Property::meta,Property::meta, "srcMonolithExecParameter");
		Property::meta_srcMonolithExecParameter_rev = MonolithicImplementation::meta_dstMonolithExecParameter;
		Uml::SetAssocRole(MonolithicImplementation::meta_dstMonolithprimaryArtifact,ImplementationArtifactReference::meta,ImplementationArtifactReference::meta, "srcMonolithprimaryArtifact");
		...
		Uml::SetAssocRole(ComponentPropertyDescription::meta_srcComponentProperty,ComponentType::meta,ComponentType::meta, "dstComponentProperty");
		...
		Uml::SetAssocRole(ComponentType::meta_dstComponentConfigProperty,Property::meta,Property::meta, "srcComponentConfigProperty");
		Property::meta_srcComponentConfigProperty_rev = ComponentType::meta_dstComponentConfigProperty;
		Uml::SetAssocRole(ComponentType::meta_dstComponentInfoProperty,Property::meta,Property::meta, "srcComponentInfoProperty");
		Property::meta_srcComponentInfoProperty_rev = ComponentType::meta_dstComponentInfoProperty;
		Uml::SetAssocRole(ComponentType::meta_srcImplements,ComponentImplementation::meta,ComponentImplementation::meta, "dstImplements");
		ComponentImplementation::meta_dstImplements_rev = ComponentType::meta_srcImplements;
		Uml::SetAssocRole(ComponentType::meta_srcPackageInterface,ComponentPackage::meta,ComponentPackage::meta, "dstPackageInterface");
		ComponentPackage::meta_dstPackageInterface_rev = ComponentType::meta_srcPackageInterface;
		Uml::SetAssocRole(ComponentType::meta_dstComponentProperty,ComponentPropertyDescription::meta,ComponentPropertyDescription::meta, "srcComponentProperty");
		ComponentPropertyDescription::meta_srcComponentProperty_rev = ComponentType::meta_dstComponentProperty;
		Uml::SetAssocRole(ComponentType::meta_ref,Component::meta,Component::meta, "referedbyComponentType");
		Uml::SetAssocRole(ComponentType::meta_CollocationGroup,CollocationGroup::meta,CollocationGroup::meta, "members");


		Uml::SetAssocRole(SharedResource::meta_srcShares,Node::meta,Node::meta, "dstShares");
		Node::meta_dstShares_rev = SharedResource::meta_srcShares;

		Uml::SetAssocRole(NodeReference::meta_srcInstanceMapping,CollocationGroup::meta,CollocationGroup::meta, "dstInstanceMapping");
		CollocationGroup::meta_dstInstanceMapping_rev = NodeReference::meta_srcInstanceMapping;
		Uml::SetAssocRole(NodeReference::meta_ref,Node::meta,Node::meta, "referedbyNodeReference");

		Uml::SetAssocRole(Bridge::meta_srcInterconnect2Bridge,Interconnect::meta,Interconnect::meta, "dstInterconnect2Bridge");
		Interconnect::meta_dstInterconnect2Bridge_rev = Bridge::meta_srcInterconnect2Bridge;
		Uml::SetAssocRole(Bridge::meta_dstBridge2Interconnect,Interconnect::meta,Interconnect::meta, "srcBridge2Interconnect");
		Interconnect::meta_srcBridge2Interconnect_rev = Bridge::meta_dstBridge2Interconnect;

		Uml::SetAssocRole(Node::meta_dstShares,SharedResource::meta,SharedResource::meta, "srcShares");
		SharedResource::meta_srcShares_rev = Node::meta_dstShares;
		Uml::SetAssocRole(Node::meta_referedbyNodeReference,NodeReference::meta,NodeReference::meta, "ref");
		Uml::SetAssocRole(Node::meta_dstNode2Interconnect,Interconnect::meta,Interconnect::meta, "srcNode2Interconnect");
		Interconnect::meta_srcNode2Interconnect_rev = Node::meta_dstNode2Interconnect;
		Uml::SetAssocRole(Node::meta_srcInterconnect2Node,Interconnect::meta,Interconnect::meta, "dstInterconnect2Node");
		Interconnect::meta_dstInterconnect2Node_rev = Node::meta_srcInterconnect2Node;

		Uml::SetAssocRole(Interconnect::meta_dstInterconnect2Bridge,Bridge::meta,Bridge::meta, "srcInterconnect2Bridge");
		Bridge::meta_srcInterconnect2Bridge_rev = Interconnect::meta_dstInterconnect2Bridge;
		Uml::SetAssocRole(Interconnect::meta_srcBridge2Interconnect,Bridge::meta,Bridge::meta, "dstBridge2Interconnect");
		Bridge::meta_dstBridge2Interconnect_rev = Interconnect::meta_srcBridge2Interconnect;
		Uml::SetAssocRole(Interconnect::meta_srcNode2Interconnect,Node::meta,Node::meta, "dstNode2Interconnect");
		Node::meta_dstNode2Interconnect_rev = Interconnect::meta_srcNode2Interconnect;
		Uml::SetAssocRole(Interconnect::meta_dstInterconnect2Node,Node::meta,Node::meta, "srcInterconnect2Node");
		...
		Uml::SetAssocRole(CollocationGroup::meta_members,ComponentType::meta,ComponentType::meta, "CollocationGroup");
		Uml::SetAssocRole(CollocationGroup::meta_dstInstanceMapping,NodeReference::meta,NodeReference::meta, "srcInstanceMapping");
		NodeReference::meta_srcInstanceMapping_rev = CollocationGroup::meta_dstInstanceMapping;

		Uml::SetAssocRole(PackageConfigurationReference::meta_srcpackage,TopLevelPackage::meta,TopLevelPackage::meta, "dstpackage");
		TopLevelPackage::meta_dstpackage_rev = PackageConfigurationReference::meta_srcpackage;
		Uml::SetAssocRole(PackageConfigurationReference::meta_ref,PackageConfiguration::meta,PackageConfiguration::meta, "referedbyPackageConfigurationReference");
		Uml::SetAssocRole(PackageConfigurationReference::meta_srcPackageConfSpecializedConfig,PackageConfiguration::meta,PackageConfiguration::meta, "dstPackageConfSpecializedConfig");
		...
		Uml::SetAssocRole(PackageConfiguration::meta_dstPackageConfConfigProperty,Property::meta,Property::meta, "srcPackageConfConfigProperty");
		Property::meta_srcPackageConfConfigProperty_rev = PackageConfiguration::meta_dstPackageConfConfigProperty;
		Uml::SetAssocRole(PackageConfiguration::meta_dstPackageConfSelectRequirement,Requirement::meta,Requirement::meta, "srcPackageConfSelectRequirement");
		Requirement::meta_srcPackageConfSelectRequirement_rev = PackageConfiguration::meta_dstPackageConfSelectRequirement;
		Uml::SetAssocRole(PackageConfiguration::meta_dstPackageConfBasePackage,ComponentPackage::meta,ComponentPackage::meta, "srcPackageConfBasePackage");
		ComponentPackage::meta_srcPackageConfBasePackage_rev = PackageConfiguration::meta_dstPackageConfBasePackage;
		Uml::SetAssocRole(PackageConfiguration::meta_dstPackageConfReference,ComponentPackageReference::meta,ComponentPackageReference::meta, "srcPackageConfReference");
		ComponentPackageReference::meta_srcPackageConfReference_rev = PackageConfiguration::meta_dstPackageConfReference;
		Uml::SetAssocRole(PackageConfiguration::meta_referedbyPackageConfigurationReference,PackageConfigurationReference::meta,PackageConfigurationReference::meta, "ref");
		Uml::SetAssocRole(PackageConfiguration::meta_dstPackageConfSpecializedConfig,PackageConfigurationReference::meta,PackageConfigurationReference::meta, "srcPackageConfSpecializedConfig");
		...
		Uml::SetAssocRole(ImplementationArtifact::meta_dstArtifactInfoProperty,Property::meta,Property::meta, "srcArtifactInfoProperty");
		Property::meta_srcArtifactInfoProperty_rev = ImplementationArtifact::meta_dstArtifactInfoProperty;
		Uml::SetAssocRole(ImplementationArtifact::meta_dstArtifactExecParameter,Property::meta,Property::meta, "srcArtifactExecParameter");
		Property::meta_srcArtifactExecParameter_rev = ImplementationArtifact::meta_dstArtifactExecParameter;
		Uml::SetAssocRole(ImplementationArtifact::meta_dstArtifactDeployRequirement,Requirement::meta,Requirement::meta, "srcArtifactDeployRequirement");
		Requirement::meta_srcArtifactDeployRequirement_rev = ImplementationArtifact::meta_dstArtifactDeployRequirement;
		Uml::SetAssocRole(ImplementationArtifact::meta_dstArtifactDependsOn,ImplementationArtifactReference::meta,ImplementationArtifactReference::meta, "srcArtifactDependsOn");
		ImplementationArtifactReference::meta_srcArtifactDependsOn_rev = ImplementationArtifact::meta_dstArtifactDependsOn;
		Uml::SetAssocRole(ImplementationArtifact::meta_referedbyImplementationArtifactReference,ImplementationArtifactReference::meta,ImplementationArtifactReference::meta, "ref");
		...
		Uml::SetAssocRole(ImplementationArtifactReference::meta_srcMonolithprimaryArtifact,MonolithicImplementation::meta,MonolithicImplementation::meta, "dstMonolithprimaryArtifact");
		...
		Uml::SetAssocRole(ImplementationArtifactReference::meta_srcArtifactDependsOn,ImplementationArtifact::meta,ImplementationArtifact::meta, "dstArtifactDependsOn");
		ImplementationArtifact::meta_dstArtifactDependsOn_rev = ImplementationArtifactReference::meta_srcArtifactDependsOn;
		Uml::SetAssocRole(ImplementationArtifactReference::meta_ref,ImplementationArtifact::meta,ImplementationArtifact::meta, "referedbyImplementationArtifactReference");

		Uml::SetAssocRole(InParameter::meta_ref,MemberType::meta,MemberType::meta, "referedbyInParameter");
		...
		Uml::SetAssocRole(InoutParameter::meta_ref,MemberType::meta,MemberType::meta, "referedbyInoutParameter");

		Uml::SetAssocRole(OutParameter::meta_ref,MemberType::meta,MemberType::meta, "referedbyOutParameter");

		Uml::SetAssocRole(ReturnType::meta_ref,MemberType::meta,MemberType::meta, "referedbyReturnType");

		Uml::SetAssocRole(Exception::meta_referedbySetException,SetException::meta,SetException::meta, "ref");
		Uml::SetAssocRole(Exception::meta_referedbyExceptionRef,ExceptionRef::meta,ExceptionRef::meta, "ref");
		Uml::SetAssocRole(Exception::meta_referedbyGetException,GetException::meta,GetException::meta, "ref");


		Uml::SetAssocRole(ConstantType::meta_referedbyConstant,Constant::meta,Constant::meta, "ref");
		Uml::SetAssocRole(ConstantType::meta_referedbyDiscriminator,Discriminator::meta,Discriminator::meta, "ref");

		Uml::SetAssocRole(File::meta_referedbyFileRef,FileRef::meta,FileRef::meta, "ref");

		Uml::SetAssocRole(Constant::meta_ref,ConstantType::meta,ConstantType::meta, "referedbyConstant");


		Uml::SetAssocRole(FileRef::meta_ref,File::meta,File::meta, "referedbyFileRef");

		Uml::SetAssocRole(ExceptionRef::meta_ref,Exception::meta,Exception::meta, "referedbyExceptionRef");



		Uml::SetAssocRole(Member::meta_ref,MemberType::meta,MemberType::meta, "referedbyMember");
		Uml::SetAssocRole(Member::meta_dstLabelConnection,Label::meta,Label::meta, "srcLabelConnection");
		Label::meta_srcLabelConnection_rev = Member::meta_dstLabelConnection;
		Uml::SetAssocRole(Member::meta_dstMakeMemberPrivate,PrivateFlag::meta,PrivateFlag::meta, "srcMakeMemberPrivate");
		PrivateFlag::meta_srcMakeMemberPrivate_rev = Member::meta_dstMakeMemberPrivate;

		Uml::SetAssocRole(Boxed::meta_ref,MemberType::meta,MemberType::meta, "referedbyBoxed");


		Uml::SetAssocRole(Label::meta_srcLabelConnection,Member::meta,Member::meta, "dstLabelConnection");
		Member::meta_dstLabelConnection_rev = Label::meta_srcLabelConnection;

		Uml::SetAssocRole(MemberType::meta_referedbyInParameter,InParameter::meta,InParameter::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyInoutParameter,InoutParameter::meta,InoutParameter::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyOutParameter,OutParameter::meta,OutParameter::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyReturnType,ReturnType::meta,ReturnType::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyMember,Member::meta,Member::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyBoxed,Boxed::meta,Boxed::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyAlias,Alias::meta,Alias::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyCollection,Collection::meta,Collection::meta, "ref");
		Uml::SetAssocRole(MemberType::meta_referedbyAttributeMember,AttributeMember::meta,AttributeMember::meta, "ref");


		Uml::SetAssocRole(Alias::meta_ref,MemberType::meta,MemberType::meta, "referedbyAlias");

		Uml::SetAssocRole(Collection::meta_ref,MemberType::meta,MemberType::meta, "referedbyCollection");


		Uml::SetAssocRole(Discriminator::meta_ref,ConstantType::meta,ConstantType::meta, "referedbyDiscriminator");
		...
		Uml::SetAssocRole(PredefinedType::meta_referedbyDataType,DataType::meta,DataType::meta, "ref");


		Uml::SetAssocRole(SetException::meta_ref,Exception::meta,Exception::meta, "referedbySetException");

		Uml::SetAssocRole(LookupKey::meta_ref,ValueObject::meta,ValueObject::meta, "referedbyLookupKey");



		Uml::SetAssocRole(Supports::meta_ref,Object::meta,Object::meta, "referedbySupports");



		Uml::SetAssocRole(Inheritable::meta_referedbyInherits,Inherits::meta,Inherits::meta, "ref");
		...
		Uml::SetAssocRole(PrivateFlag::meta_srcMakeMemberPrivate,Member::meta,Member::meta, "dstMakeMemberPrivate");
		Member::meta_dstMakeMemberPrivate_rev = PrivateFlag::meta_srcMakeMemberPrivate;

		Uml::SetAssocRole(GetException::meta_ref,Exception::meta,Exception::meta, "referedbyGetException");


		Uml::SetAssocRole(Inherits::meta_ref,Inheritable::meta,Inheritable::meta, "referedbyInherits");

		Uml::SetAssocRole(Object::meta_referedbySupports,Supports::meta,Supports::meta, "ref");

		Uml::SetAssocRole(ValueObject::meta_referedbyLookupKey,LookupKey::meta,LookupKey::meta, "ref");

		Uml::SetAssocRole(Event::meta_referedbyInEventPort,InEventPort::meta,InEventPort::meta, "ref");
		Uml::SetAssocRole(Event::meta_referedbyOutEventPort,OutEventPort::meta,OutEventPort::meta, "ref");

		Uml::SetAssocRole(AttributeMember::meta_ref,MemberType::meta,MemberType::meta, "referedbyAttributeMember");
		...
		Uml::SetAssocRole(ComponentRef::meta_ref,Component::meta,Component::meta, "referedbyComponentRef");

		Uml::SetAssocRole(ComponentFactory::meta_dstManagesComponent,Manageable::meta,Manageable::meta, "srcManagesComponent");
		Manageable::meta_srcManagesComponent_rev = ComponentFactory::meta_dstManagesComponent;

		Uml::SetAssocRole(Manageable::meta_srcManagesComponent,ComponentFactory::meta,ComponentFactory::meta, "dstManagesComponent");
		ComponentFactory::meta_dstManagesComponent_rev = Manageable::meta_srcManagesComponent;

		Uml::SetAssocRole(Provideable::meta_referedbyRequiredRequestPort,RequiredRequestPort::meta,RequiredRequestPort::meta, "ref");
		Uml::SetAssocRole(Provideable::meta_referedbyProvidedRequestPort,ProvidedRequestPort::meta,ProvidedRequestPort::meta, "ref");


		Uml::SetAssocRole(ProvidedRequestPort::meta_srcinvoke,RequiredRequestPort::meta,RequiredRequestPort::meta, "dstinvoke");
		RequiredRequestPort::meta_dstinvoke_rev = ProvidedRequestPort::meta_srcinvoke;
		Uml::SetAssocRole(ProvidedRequestPort::meta_ref,Provideable::meta,Provideable::meta, "referedbyProvidedRequestPort");

		Uml::SetAssocRole(RequiredRequestPort::meta_dstinvoke,ProvidedRequestPort::meta,ProvidedRequestPort::meta, "srcinvoke");
		ProvidedRequestPort::meta_srcinvoke_rev = RequiredRequestPort::meta_dstinvoke;
		Uml::SetAssocRole(RequiredRequestPort::meta_ref,Provideable::meta,Provideable::meta, "referedbyRequiredRequestPort");

		Uml::SetAssocRole(OutEventPort::meta_dstemit,InEventPort::meta,InEventPort::meta, "srcemit");
		InEventPort::meta_srcemit_rev = OutEventPort::meta_dstemit;
		Uml::SetAssocRole(OutEventPort::meta_dstpublish,PublishConnector::meta,PublishConnector::meta, "srcpublish");
		PublishConnector::meta_srcpublish_rev = OutEventPort::meta_dstpublish;
		Uml::SetAssocRole(OutEventPort::meta_ref,Event::meta,Event::meta, "referedbyOutEventPort");

		Uml::SetAssocRole(InEventPort::meta_srcemit,OutEventPort::meta,OutEventPort::meta, "dstemit");
		OutEventPort::meta_dstemit_rev = InEventPort::meta_srcemit;
		Uml::SetAssocRole(InEventPort::meta_srcdeliverTo,PublishConnector::meta,PublishConnector::meta, "dstdeliverTo");
		PublishConnector::meta_dstdeliverTo_rev = InEventPort::meta_srcdeliverTo;
		Uml::SetAssocRole(InEventPort::meta_ref,Event::meta,Event::meta, "referedbyInEventPort");

		Uml::SetAssocRole(Component::meta_dstAssemblyConfigProperty,Property::meta,Property::meta, "srcAssemblyConfigProperty");
		Property::meta_srcAssemblyConfigProperty_rev = Component::meta_dstAssemblyConfigProperty;
		Uml::SetAssocRole(Component::meta_dstAssemblyselectRequirement,Requirement::meta,Requirement::meta, "srcAssemblyselectRequirement");
		Requirement::meta_srcAssemblyselectRequirement_rev = Component::meta_dstAssemblyselectRequirement;
		Uml::SetAssocRole(Component::meta_referedbyComponentType,ComponentType::meta,ComponentType::meta, "ref");
		Uml::SetAssocRole(Component::meta_referedbyComponentRef,ComponentRef::meta,ComponentRef::meta, "ref");
