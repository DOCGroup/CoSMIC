...
namespace PICMLCadena_Xchange_embedded_EIProperties {
	 ...
	 void Initialize()
	{
		...
		RootContainer::meta_componentAssembly = PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties::meta_componentAssembly;
		{
