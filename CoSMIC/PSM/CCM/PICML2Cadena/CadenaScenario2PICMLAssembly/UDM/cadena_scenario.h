...
namespace cadena_scenario {
	...
	class  ComponentPort :  public Object {
	 public:
		...
		Udm::CrossAssocAttr<PICML::Port> picmlPort() const { return Udm::CrossAssocAttr<PICML::Port>(impl, meta_picmlPort); }
		template<class Pred> Udm::CrossAssocAttr<PICML::Port, Pred> picmlPort_sorted(const Pred &) const { return Udm::CrossAssocAttr<PICML::Port, Pred>(impl, meta_picmlPort); }
