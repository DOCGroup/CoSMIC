// cpp(meta datanetwork format) source file PICMLAssembly2CadenaScenario.cpp generated from diagram PICMLAssembly2CadenaScenario
...
namespace PICMLAssembly2CadenaScenario {
	 ...
	 void Initialize()
	{
		...
		meta_dn->CreateNew("PICMLAssembly2CadenaScenario.mem", "", Uml::Diagram::meta, Udm::CHANGES_LOST_DEFAULT);
		umldiagram = Uml::Diagram::Cast(meta_dn->GetRootObject());
		umldiagram.name() ="PICMLAssembly2CadenaScenario";
		umldiagram.version() ="1.00";
		Creates();
		InitClassesAttributes();
		Uml::InitDiagram(umldiagram, "PICMLAssembly2CadenaScenario", "1.00");
	...
	static struct _regClass
	{
		_regClass()
		{
			Udm::MetaDepository::StoreDiagram("PICMLAssembly2CadenaScenario", diagram);
		};
		~_regClass()
		{
			Udm::MetaDepository::RemoveDiagram("PICMLAssembly2CadenaScenario");
		};
	} __regUnUsed;

}
// END PICMLAssembly2CadenaScenario.cpp
