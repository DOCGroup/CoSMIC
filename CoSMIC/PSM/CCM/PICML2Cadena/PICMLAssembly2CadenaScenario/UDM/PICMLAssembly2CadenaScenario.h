...
namespace PICMLAssembly2CadenaScenario {
	...
	class  ESSConnection_cross_ph_cadena_scenario :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<ESSConnection_cross_ph_cadena_scenario> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::InstantiatedAttr<ESSConnection_cross_ph_cadena_scenario, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl);}
		...
		Udm::AssocAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML> picmlEmit() const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl, meta_picmlEmit); }
		template <class Pred> Udm::AssocAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred > picmlEmit_sorted(const Pred &) const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred>(impl, meta_picmlEmit); }

		static Uml::AssociationRole meta_picmlPublishConnector;
		Udm::AssocAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML> picmlPublishConnector() const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl, meta_picmlPublishConnector); }
		template <class Pred> Udm::AssocAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred > picmlPublishConnector_sorted(const Pred &) const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred>(impl, meta_picmlPublishConnector); }
	...
	class  RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl);}
		template <class Pred> Udm::InstantiatedAttr<RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML> componentAssembly() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl, meta_componentAssembly); }
	...
	class  FRConnection_cross_ph_cadena_scenario :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<FRConnection_cross_ph_cadena_scenario> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::InstantiatedAttr<FRConnection_cross_ph_cadena_scenario, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML> picmlInvoke() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl, meta_picmlInvoke); }
	...
	class  ComponentPort_cross_ph_cadena_scenario :  public Udm::Object {
	 public:
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::Port_cross_ph_PICML> picmlPort() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::Port_cross_ph_PICML>(impl, meta_picmlPort); }
	...
	class  ComponentInstance_cross_ph_cadena_scenario :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<ComponentInstance_cross_ph_cadena_scenario> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::InstantiatedAttr<ComponentInstance_cross_ph_cadena_scenario, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML> picmlComponentDef() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl, meta_picmlComponentDef); }
	...
	class  PublishConnector_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<PublishConnector_cross_ph_PICML> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl);}
		template <class Pred> Udm::InstantiatedAttr<PublishConnector_cross_ph_PICML, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> cadenaESSConnection() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl, meta_cadenaESSConnection); }
	...
	class  ComponentAssembly_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<ComponentAssembly_cross_ph_PICML> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl);}
		template <class Pred> Udm::InstantiatedAttr<ComponentAssembly_cross_ph_PICML, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> rootContainer() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl, meta_rootContainer); }
	...
	class  emit_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<emit_cross_ph_PICML> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl);}
		template <class Pred> Udm::InstantiatedAttr<emit_cross_ph_PICML, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl);}
		...
		Udm::AssocAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> cadenaEmit() const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl, meta_cadenaEmit); }
		template <class Pred> Udm::AssocAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred > cadenaEmit_sorted(const Pred &) const { return Udm::AssocAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred>(impl, meta_cadenaEmit); }
	...
	class  invoke_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<invoke_cross_ph_PICML> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl);}
		template <class Pred> Udm::InstantiatedAttr<invoke_cross_ph_PICML, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario> cadenaInvoke() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl, meta_cadenaInvoke); }
	...
	class  Component_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::InstantiatedAttr<Component_cross_ph_PICML> Instances() { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl);}
		template <class Pred> Udm::InstantiatedAttr<Component_cross_ph_PICML, Pred> Instances_sorted(const Pred &) { return Udm::InstantiatedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred>(impl);}

		Udm::DerivedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML> Derived() { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl);}
		template <class Pred> Udm::DerivedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred> Derived_sorted(const Pred &) { return Udm::DerivedAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred>(impl);}

		Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML> Archetype() { return Udm::ArchetypeAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl);}
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario> cadenaComponentInstance() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl, meta_cadenaComponentInstance); }
	...
	class  Port_cross_ph_PICML :  public Udm::Object {
	 public:
		...
		Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentPort_cross_ph_cadena_scenario> cadenaPort() const { return Udm::PointerAttr<PICMLAssembly2CadenaScenario::ComponentPort_cross_ph_cadena_scenario>(impl, meta_cadenaPort); }
	...
	class  _gen_cont :  public Udm::Object {
	 public:
		...
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> ESSConnection_cross_ph_cadena_scenario_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl, meta_ESSConnection_cross_ph_cadena_scenario_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred> ESSConnection_cross_ph_cadena_scenario_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred>(impl, meta_ESSConnection_cross_ph_cadena_scenario_children); }

		static Uml::CompositionChildRole meta_RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl, meta_RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred> RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred>(impl, meta_RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_children); }

		static Uml::CompositionChildRole meta_FRConnection_cross_ph_cadena_scenario_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario> FRConnection_cross_ph_cadena_scenario_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl, meta_FRConnection_cross_ph_cadena_scenario_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred> FRConnection_cross_ph_cadena_scenario_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred>(impl, meta_FRConnection_cross_ph_cadena_scenario_children); }
		...
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario> ComponentInstance_cross_ph_cadena_scenario_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl, meta_ComponentInstance_cross_ph_cadena_scenario_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred> ComponentInstance_cross_ph_cadena_scenario_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred>(impl, meta_ComponentInstance_cross_ph_cadena_scenario_children); }

		static Uml::CompositionChildRole meta_PublishConnector_cross_ph_PICML_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML> PublishConnector_cross_ph_PICML_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl, meta_PublishConnector_cross_ph_PICML_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred> PublishConnector_cross_ph_PICML_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred>(impl, meta_PublishConnector_cross_ph_PICML_children); }

		static Uml::CompositionChildRole meta_ComponentAssembly_cross_ph_PICML_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML> ComponentAssembly_cross_ph_PICML_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl, meta_ComponentAssembly_cross_ph_PICML_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred> ComponentAssembly_cross_ph_PICML_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred>(impl, meta_ComponentAssembly_cross_ph_PICML_children); }

		static Uml::CompositionChildRole meta_emit_cross_ph_PICML_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML> emit_cross_ph_PICML_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl, meta_emit_cross_ph_PICML_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred> emit_cross_ph_PICML_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred>(impl, meta_emit_cross_ph_PICML_children); }

		static Uml::CompositionChildRole meta_invoke_cross_ph_PICML_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML> invoke_cross_ph_PICML_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl, meta_invoke_cross_ph_PICML_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred> invoke_cross_ph_PICML_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred>(impl, meta_invoke_cross_ph_PICML_children); }

		static Uml::CompositionChildRole meta_Component_cross_ph_PICML_children;
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML> Component_cross_ph_PICML_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl, meta_Component_cross_ph_PICML_children); }
		 template <class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred> Component_cross_ph_PICML_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred>(impl, meta_Component_cross_ph_PICML_children); }
		...
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario> ESSConnection_cross_ph_cadena_scenario_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred> ESSConnection_cross_ph_cadena_scenario_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ESSConnection_cross_ph_cadena_scenario, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties> RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred> RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario> FRConnection_cross_ph_cadena_scenario_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred> FRConnection_cross_ph_cadena_scenario_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::FRConnection_cross_ph_cadena_scenario, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario> ComponentInstance_cross_ph_cadena_scenario_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred> ComponentInstance_cross_ph_cadena_scenario_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentInstance_cross_ph_cadena_scenario, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML> PublishConnector_cross_ph_PICML_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred> PublishConnector_cross_ph_PICML_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::PublishConnector_cross_ph_PICML, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML> ComponentAssembly_cross_ph_PICML_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred> ComponentAssembly_cross_ph_PICML_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::ComponentAssembly_cross_ph_PICML, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML> emit_cross_ph_PICML_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred> emit_cross_ph_PICML_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::emit_cross_ph_PICML, Pred>(impl, Udm::NULLCHILDROLE); }

		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML> invoke_cross_ph_PICML_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred> invoke_cross_ph_PICML_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::invoke_cross_ph_PICML, Pred>(impl, Udm::NULLCHILDROLE); }
		...
		Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML> Component_cross_ph_PICML_kind_children() const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML>(impl, Udm::NULLCHILDROLE); }
		template<class Pred> Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred> Component_cross_ph_PICML_kind_children_sorted(const Pred &) const { return Udm::ChildrenAttr<PICMLAssembly2CadenaScenario::Component_cross_ph_PICML, Pred>(impl, Udm::NULLCHILDROLE); }
