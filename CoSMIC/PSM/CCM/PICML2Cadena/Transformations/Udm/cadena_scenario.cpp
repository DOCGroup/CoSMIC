...
namespace cadena_scenario {
	...
	Uml::AssociationRole Property::meta_picmlProperty;
	Uml::AssociationRole ComponentInstance::meta_picmlComponentDef;
	Uml::AssociationRole Scenario::meta_picmlComponentAssembly;
	 ...
	 void Initialize()
	{
		...
		ESSConnection::meta_picmlPublishConnector = Cadena2PICML::ESSConnection_cross_ph_cadena_scenario::meta_picmlPublishConnector;
		ESSConnection::meta_picmlEmit = Cadena2PICML::ESSConnection_cross_ph_cadena_scenario::meta_picmlEmit;
		FRConnection::meta_picmlInvoke = Cadena2PICML::FRConnection_cross_ph_cadena_scenario::meta_picmlInvoke;
		ComponentPort::meta_picmlPort = Cadena2PICML::ComponentPort_cross_ph_cadena_scenario::meta_picmlPort;
		Property::meta_picmlProperty = Cadena2PICML::Property_cross_ph_cadena_scenario::meta_picmlProperty;
		ComponentInstance::meta_picmlComponentDef = Cadena2PICML::ComponentInstance_cross_ph_cadena_scenario::meta_picmlComponentDef;
		Scenario::meta_picmlComponentAssembly = Cadena2PICML::Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly;
		{
