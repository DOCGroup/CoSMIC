...
namespace cadena_scenario {
	 ...
	 void Initialize()
	{
		...
		InitAssociation1();
		InitAssociation2();
		ESSConnection::meta_picmlEmit = PICML2Cadena::ESSConnection_cross_ph_cadena_scenario::meta_picmlEmit;
		ESSConnection::meta_picmlPublishConnector = PICML2Cadena::ESSConnection_cross_ph_cadena_scenario::meta_picmlPublishConnector;
		FRConnection::meta_picmlInvoke = PICML2Cadena::FRConnection_cross_ph_cadena_scenario::meta_picmlInvoke;
		ComponentPort::meta_picmlPort = PICML2Cadena::ComponentPort_cross_ph_cadena_scenario::meta_picmlPort;
		ComponentInstance::meta_picmlComponentDef = PICML2Cadena::ComponentInstance_cross_ph_cadena_scenario::meta_picmlComponentDef;
		InitComposition0();
		InitComposition1();
		InitComposition2();
		InitComposition3();
