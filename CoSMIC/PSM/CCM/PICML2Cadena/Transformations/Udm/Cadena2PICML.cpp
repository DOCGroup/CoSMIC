...
namespace Cadena2PICML {
	...
	Uml::Attribute Property_cross_ph_PICML::meta_rem_id;
	...
	void Creates()
	{
		...
		Property_cross_ph_PICML::meta_rem_id = Uml::Attribute::Create(Property_cross_ph_PICML::meta);
	...
	void InitClassesAttributes()
	{
		...
		Property_cross_ph_PICML::meta.name() = "Property_cross_ph_PICML";
		Property_cross_ph_PICML::meta.isAbstract() = false;
		Property_cross_ph_PICML::meta.from() = "PICML";
		...
		Scenario_cross_ph_cadena_scenario::meta_rem_id.max() = 1;
		Scenario_cross_ph_cadena_scenario::meta_rem_id.nonpersistent() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_id.registry() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_id.ordered() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_id.visibility() = "";
		Scenario_cross_ph_cadena_scenario::meta_rem_id.defvalue() = vector<string>();
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.name() = "rem_sysname";
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.type() = "String";
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.min() = 1;
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.max() = 1;
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.nonpersistent() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.registry() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.ordered() = false;
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.visibility() = "";
		Scenario_cross_ph_cadena_scenario::meta_rem_sysname.defvalue() = vector<string>();
		...
		Property_cross_ph_PICML::meta_rem_id.name() = "rem_id";
		Property_cross_ph_PICML::meta_rem_id.type() = "Integer";
		Property_cross_ph_PICML::meta_rem_id.min() = 1;
		Property_cross_ph_PICML::meta_rem_id.max() = 1;
		Property_cross_ph_PICML::meta_rem_id.nonpersistent() = false;
		Property_cross_ph_PICML::meta_rem_id.registry() = false;
		Property_cross_ph_PICML::meta_rem_id.ordered() = false;
		Property_cross_ph_PICML::meta_rem_id.visibility() = "";
		Property_cross_ph_PICML::meta_rem_id.defvalue() = vector<string>();
		Property_cross_ph_PICML::meta_rem_sysname.name() = "rem_sysname";
		Property_cross_ph_PICML::meta_rem_sysname.type() = "String";
		Property_cross_ph_PICML::meta_rem_sysname.min() = 1;
		Property_cross_ph_PICML::meta_rem_sysname.max() = 1;
		Property_cross_ph_PICML::meta_rem_sysname.nonpersistent() = false;
		Property_cross_ph_PICML::meta_rem_sysname.registry() = false;
		Property_cross_ph_PICML::meta_rem_sysname.ordered() = false;
		Property_cross_ph_PICML::meta_rem_sysname.visibility() = "";
		Property_cross_ph_PICML::meta_rem_sysname.defvalue() = vector<string>();
	 ...
	 void Initialize()
	{
		...
		meta_dn->CreateNew("Cadena2PICML.mem", "", Uml::Diagram::meta, Udm::CHANGES_LOST_DEFAULT);
		umldiagram = Uml::Diagram::Cast(meta_dn->GetRootObject());
		umldiagram.name() ="Cadena2PICML";
		umldiagram.version() ="1.00";
		Creates();
		InitClassesAttributes();
		Uml::InitDiagram(umldiagram, "Cadena2PICML", "1.00");
		...
		}
		{
			...
			Property_cross_ph_cadena_scenario::meta_picmlProperty.name() = "picmlProperty";
			Property_cross_ph_cadena_scenario::meta_picmlProperty.min() = 1;
			Property_cross_ph_cadena_scenario::meta_picmlProperty.max() = 1;
			Property_cross_ph_cadena_scenario::meta_picmlProperty.isNavigable() = true;
			Property_cross_ph_cadena_scenario::meta_picmlProperty.isPrimary() = false;
			Property_cross_ph_cadena_scenario::meta_picmlProperty.target() = Property_cross_ph_PICML::meta;
			Property_cross_ph_PICML::meta_cadenaProperty = Uml::AssociationRole::Create(ass);
			Property_cross_ph_PICML::meta_cadenaProperty.name() = "cadenaProperty";
			Property_cross_ph_PICML::meta_cadenaProperty.min() = 1;
			Property_cross_ph_PICML::meta_cadenaProperty.max() = 1;
			Property_cross_ph_PICML::meta_cadenaProperty.isNavigable() = true;
		...
		{
			Uml::Association ass = Uml::Association::Create(umldiagram);
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly = Uml::AssociationRole::Create(ass);
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.name() = "picmlComponentAssembly";
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.min() = 0;
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.max() = -1;
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.isNavigable() = true;
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.isPrimary() = false;
			Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly.target() = ComponentAssembly_cross_ph_PICML::meta;
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario = Uml::AssociationRole::Create(ass);
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.name() = "cadenaScenario";
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.min() = 0;
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.max() = -1;
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.isNavigable() = true;
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.isPrimary() = false;
			ComponentAssembly_cross_ph_PICML::meta_cadenaScenario.target() = Scenario_cross_ph_cadena_scenario::meta;
		}
		{
			Uml::Association ass = Uml::Association::Create(umldiagram);
		...
		}
		{
			...
			Property_cross_ph_cadena_scenario::meta__gen_cont_parent = Uml::CompositionParentRole::Create(comp);
			Property_cross_ph_cadena_scenario::meta__gen_cont_parent.name() = "_gen_cont_parent";
			Property_cross_ph_cadena_scenario::meta__gen_cont_parent.isNavigable() = true;
			Property_cross_ph_cadena_scenario::meta__gen_cont_parent.target() = _gen_cont::meta;
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children = Uml::CompositionChildRole::Create(comp);
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children.name() = "Property_cross_ph_cadena_scenario";
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children.min() = 0;
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children.max() = -1;
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children.isNavigable() = true;
			_gen_cont::meta_Property_cross_ph_cadena_scenario_children.target() = Property_cross_ph_cadena_scenario::meta;
		}
		{
			Uml::Composition comp = Uml::Composition::Create(umldiagram);
			comp.nonpersistent() =false;
		...
		}
		{
			...
			Scenario_cross_ph_cadena_scenario::meta__gen_cont_parent = Uml::CompositionParentRole::Create(comp);
			Scenario_cross_ph_cadena_scenario::meta__gen_cont_parent.name() = "_gen_cont_parent";
			Scenario_cross_ph_cadena_scenario::meta__gen_cont_parent.isNavigable() = true;
			Scenario_cross_ph_cadena_scenario::meta__gen_cont_parent.target() = _gen_cont::meta;
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children = Uml::CompositionChildRole::Create(comp);
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children.name() = "Scenario_cross_ph_cadena_scenario";
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children.min() = 0;
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children.max() = -1;
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children.isNavigable() = true;
			_gen_cont::meta_Scenario_cross_ph_cadena_scenario_children.target() = Scenario_cross_ph_cadena_scenario::meta;
		}
		{
			Uml::Composition comp = Uml::Composition::Create(umldiagram);
			comp.nonpersistent() =false;
		...
		}
		{
			...
			Property_cross_ph_PICML::meta__gen_cont_parent = Uml::CompositionParentRole::Create(comp);
			Property_cross_ph_PICML::meta__gen_cont_parent.name() = "_gen_cont_parent";
			Property_cross_ph_PICML::meta__gen_cont_parent.isNavigable() = true;
			Property_cross_ph_PICML::meta__gen_cont_parent.target() = _gen_cont::meta;
			_gen_cont::meta_Property_cross_ph_PICML_children = Uml::CompositionChildRole::Create(comp);
			_gen_cont::meta_Property_cross_ph_PICML_children.name() = "Property_cross_ph_PICML";
			_gen_cont::meta_Property_cross_ph_PICML_children.min() = 0;
			_gen_cont::meta_Property_cross_ph_PICML_children.max() = -1;
			_gen_cont::meta_Property_cross_ph_PICML_children.isNavigable() = true;
			_gen_cont::meta_Property_cross_ph_PICML_children.target() = Property_cross_ph_PICML::meta;
		}
		{
			Uml::Composition comp = Uml::Composition::Create(umldiagram);
			comp.nonpersistent() =false;
	...
	void Initialize(const Uml::Diagram & dgr)
	{
		...
		Uml::SetClass(Property_cross_ph_PICML::meta, umldiagram, "Property_cross_ph_PICML");
		Uml::SetAttribute(Property_cross_ph_PICML::meta_rem_id,Property_cross_ph_PICML::meta, "rem_id");
		Uml::SetAttribute(Property_cross_ph_PICML::meta_rem_sysname,Property_cross_ph_PICML::meta, "rem_sysname");
		...
		// Association roles 
		Uml::SetAssocRole(FRConnection_cross_ph_cadena_scenario::meta_picmlInvoke,invoke_cross_ph_PICML::meta,invoke_cross_ph_PICML::meta, "cadenaInvoke");

		Uml::SetAssocRole(ESSConnection_cross_ph_cadena_scenario::meta_picmlPublishConnector,PublishConnector_cross_ph_PICML::meta,PublishConnector_cross_ph_PICML::meta, "cadenaESSConnection");
		Uml::SetAssocRole(ESSConnection_cross_ph_cadena_scenario::meta_picmlEmit,emit_cross_ph_PICML::meta,emit_cross_ph_PICML::meta, "cadenaEmit");





		Uml::SetAssocRole(ComponentPort_cross_ph_cadena_scenario::meta_picmlPort,Port_cross_ph_PICML::meta,Port_cross_ph_PICML::meta, "cadenaPort");

		Uml::SetAssocRole(Property_cross_ph_cadena_scenario::meta_picmlProperty,Property_cross_ph_PICML::meta,Property_cross_ph_PICML::meta, "cadenaProperty");

		Uml::SetAssocRole(ComponentInstance_cross_ph_cadena_scenario::meta_picmlComponentDef,Component_cross_ph_PICML::meta,Component_cross_ph_PICML::meta, "cadenaComponentInstance");

		Uml::SetAssocRole(Scenario_cross_ph_cadena_scenario::meta_picmlComponentAssembly,ComponentAssembly_cross_ph_PICML::meta,ComponentAssembly_cross_ph_PICML::meta, "cadenaScenario");

		Uml::SetAssocRole(RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties::meta_componentAssembly,ComponentAssembly_cross_ph_PICML::meta,ComponentAssembly_cross_ph_PICML::meta, "rootContainer");

		Uml::SetAssocRole(Property_cross_ph_PICML::meta_cadenaProperty,Property_cross_ph_cadena_scenario::meta,Property_cross_ph_cadena_scenario::meta, "picmlProperty");

		Uml::SetAssocRole(invoke_cross_ph_PICML::meta_cadenaInvoke,FRConnection_cross_ph_cadena_scenario::meta,FRConnection_cross_ph_cadena_scenario::meta, "picmlInvoke");

		Uml::SetAssocRole(ComponentAssembly_cross_ph_PICML::meta_cadenaScenario,Scenario_cross_ph_cadena_scenario::meta,Scenario_cross_ph_cadena_scenario::meta, "picmlComponentAssembly");
		Uml::SetAssocRole(ComponentAssembly_cross_ph_PICML::meta_rootContainer,RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties::meta,RootContainer_cross_ph_PICMLCadena_Xchange_embedded_EIProperties::meta, "componentAssembly");

		Uml::SetAssocRole(emit_cross_ph_PICML::meta_cadenaEmit,ESSConnection_cross_ph_cadena_scenario::meta,ESSConnection_cross_ph_cadena_scenario::meta, "picmlEmit");

		Uml::SetAssocRole(PublishConnector_cross_ph_PICML::meta_cadenaESSConnection,ESSConnection_cross_ph_cadena_scenario::meta,ESSConnection_cross_ph_cadena_scenario::meta, "picmlPublishConnector");

		Uml::SetAssocRole(Component_cross_ph_PICML::meta_cadenaComponentInstance,ComponentInstance_cross_ph_cadena_scenario::meta,ComponentInstance_cross_ph_cadena_scenario::meta, "picmlComponentDef");





		Uml::SetAssocRole(Port_cross_ph_PICML::meta_cadenaPort,ComponentPort_cross_ph_cadena_scenario::meta,ComponentPort_cross_ph_cadena_scenario::meta, "picmlPort");
	...
	static struct _regClass
	{
		_regClass()
		{
			Udm::MetaDepository::StoreDiagram("Cadena2PICML", diagram);
		};
		~_regClass()
		{
			Udm::MetaDepository::RemoveDiagram("Cadena2PICML");
		};
	} __regUnUsed;

}
// END Cadena2PICML.cpp
