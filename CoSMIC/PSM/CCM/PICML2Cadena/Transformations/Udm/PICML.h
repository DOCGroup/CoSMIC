...
// generated on Fri Oct 08 20:10:52 2004
...
namespace PICML {
	...
	class  RTEC_Filter_Group :  public Include_RT_Info_Members_Base, public Include_RTEC_Filter_Group_Members_Base, public MgaObject {
	 public:
		static Uml::Class meta;

		RTEC_Filter_Group() { }
		RTEC_Filter_Group(Udm::ObjectImpl *impl) : Include_RT_Info_Members_Base(impl),Include_RTEC_Filter_Group_Members_Base(impl),MgaObject(impl), Object(impl) { }
		RTEC_Filter_Group(const RTEC_Filter_Group &master) : Include_RT_Info_Members_Base(master),Include_RTEC_Filter_Group_Members_Base(master),MgaObject(master), Object(master) { }
	...
	class  RT_Info_Param :  public Include_RT_Info_Members_Base, public Use_RT_Info_Members_Base, public MgaObject {
	 public:
		static Uml::Class meta;

		RT_Info_Param() { }
		RT_Info_Param(Udm::ObjectImpl *impl) : Include_RT_Info_Members_Base(impl),Use_RT_Info_Members_Base(impl),MgaObject(impl), Object(impl) { }
		RT_Info_Param(const RT_Info_Param &master) : Include_RT_Info_Members_Base(master),Use_RT_Info_Members_Base(master),MgaObject(master), Object(master) { }
