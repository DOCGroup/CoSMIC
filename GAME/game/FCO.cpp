...
//
size_t FCO_Impl::
registry (std::vector <GAME::RegistryNode> & nodes,
...
// in_sets
//
size_t FCO_Impl::in_sets (std::vector <GAME::Set> & sets) const
{
...
// referenced_by
//
size_t FCO_Impl::referenced_by (std::vector <GAME::FCO> & references) const
{
  CComPtr <IMgaFCOs> temp;
