...
#ifndef _EXTENSION_CLASSES_REFERSTO_METHOD_GENERATOR_H_
#define _EXTENSION_CLASSES_REFERSTO_METHOD_GENERATOR_H_
 ...
 * extension class.
 */
class RefersTo_Method_Generator : public Visitor
{
public:
  /**
  ...
  /// Destructor.
  virtual ~RefersTo_Method_Generator (void);
...
#endif  // !defined _EXTENSION_CLASSES_REFERSTO_METHOD_GENERATOR_H_
