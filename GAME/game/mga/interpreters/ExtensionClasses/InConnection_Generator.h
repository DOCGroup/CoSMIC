...
#ifndef _EXTENSION_CLASSES_INCONNECTION_GENERATOR_H_
#define _EXTENSION_CLASSES_INCONNECTION_GENERATOR_H_
 ...
 * extension class.
 */
class InConnection_Generator : public Visitor
{
public:
  /**
  ...
  /// Destructor.
  virtual ~InConnection_Generator (void);
