        ...
        case 1:
          {
            if (left_value > right_value)
            {
             ...
             // Counting the number of objects to be deleted
              ...
              ret = list_delete (res.model_object, count, left_metatype, left_metarole);
            }
            break;
          }
        case 2:
        ...
        case 3:
          {
            ...
            {
              // Options for the modeler if the left side is greater than right side
            ...
            if (options.size () > 0)
            {
              ...
              if (!select.empty ())
              {
                if (select == ("Add " + left_metatype->name ()))
                  ...
                  ret = list_delete (res.model_object, count, right_metatype, right_metarole);
                else if (select == ("Add " + right_metatype->name ()))
                  ret = list_add (res.model_object, count, right_metatype, right_metarole);
                else if (select == ("Delete " + left_metatype->name ()))
                  ret = list_delete (res.model_object, count, left_metatype, left_metarole);
              }
            }
            break;
