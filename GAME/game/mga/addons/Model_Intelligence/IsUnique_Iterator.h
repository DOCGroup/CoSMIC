...
#ifndef _GAME_MODEL_INTELLIGENCE_ISUNIQUE_ITERATOR_H_
#define _GAME_MODEL_INTELLIGENCE_ISUNIQUE_ITERATOR_H_
 ...
 * returns true if sub-expression evaluates to different
 * values for all the elements.
 */
class IsUnique_Iterator : public Iterator
{
public:
  /// Default constructor.
