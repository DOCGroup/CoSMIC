...
// Constructor
//
One_Iterator::One_Iterator (void)
{
}
...
// evaluate
//
Value * One_Iterator::evaluate (Ocl_Context & res,
...
// is_association
//
bool One_Iterator::is_association (void)
{
  return true;
}
...
// is_containment
//
bool One_Iterator::is_containment (void)
{
  return false;
}
...
// is_reference
//
bool One_Iterator::is_reference (void)
{
  return false;
}