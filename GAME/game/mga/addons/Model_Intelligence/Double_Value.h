...
#ifndef _GAME_MODEL_INTELLIGENCE_DOUBLE_VALUE_H_
#define _GAME_MODEL_INTELLIGENCE_DOUBLE_VALUE_H_
...
/**
 * @class Double_Value. Inherited from Value class
 *
 * This class deals with double type of values
 */
