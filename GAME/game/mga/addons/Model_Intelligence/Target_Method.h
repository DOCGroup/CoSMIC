...
#ifndef _GAME_MODEL_INTELLIGENCE_TARGET_METHOD_H_
#define _GAME_MODEL_INTELLIGENCE_TARGET_METHOD_H_
 ...
 * with finding the target FCO of the connection point
 */
class Target_Method : public Method
{
public:
  /// Default constructor.
	Target_Method (void);
  ...
  /**
   * evaluate method for evaluating the target method
   *
...
#endif //_GAME_MODEL_INTELLIGENCE_TARGET_METHOD_H_