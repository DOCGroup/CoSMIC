...
#ifndef _GAME_MODEL_INTELLIGENCE_GREATER_EXPR_H_
#define _GAME_MODEL_INTELLIGENCE_GREATER_EXPR_H_
 ...
 * checking the greater than relation between two variables.
 * The basic syntax being "A > B", where A & B both can be local variables
 * or one can be a constant value
 */
class Greater_Expr : public Comparison_Expr
{
public:
  /// Default constructor.
	Greater_Expr (Value_Expr * left, Value_Expr * right);
