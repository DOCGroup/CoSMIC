...
#ifndef _GAME_MODEL_INTELLIGENCE_EXISTS_ITERATOR_H_
#define _GAME_MODEL_INTELLIGENCE_EXISTS_ITERATOR_H_
 ...
 */
class Exists_Iterator : public Iterator
{
public:
  /// Default constructor.
