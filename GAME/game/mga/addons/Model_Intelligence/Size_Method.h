...
#ifndef _GAME_MODEL_INTELLIGENCE_SIZE_METHOD_H_
#define _GAME_MODEL_INTELLIGENCE_SIZE_METHOD_H_
 ...
 * with the size of the collection value passed to it
 */
class Size_Method : public Method
{
public:
  /// Default constructor.
	Size_Method (void);
  ...
  /**
   * evaluate method for evaluating the size method
   *
