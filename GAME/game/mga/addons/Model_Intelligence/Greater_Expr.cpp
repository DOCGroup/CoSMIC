...
bool Greater_Expr::evaluate (Ocl_Context & res)
{
  ...
  else if (res.model_attributes)
  {
    ...
    if (left != 0 || right != 0 )
    {
      ...
      ret = this->lhs_->evaluate (res)->is_greater (this->rhs_->evaluate (res));
...
// filter_evaluate
//
bool Greater_Expr::filter_evaluate (Ocl_Context & res, 
...
// list_add
//
bool Greater_Expr::list_add (GAME::Mga::Model & obj, 
                             size_t count, 
...
// list delete
//
bool Greater_Expr::list_delete (GAME::Mga::Model & obj,
                                size_t count, 
                                GAME::Mga::Meta::FCO & metatype,
                                GAME::Mga::Meta::Role & metarole)
{
