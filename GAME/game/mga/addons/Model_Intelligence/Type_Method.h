...
#ifndef _GAME_MODEL_INTELLIGENCE_TYPE_METHOD_H_
#define _GAME_MODEL_INTELLIGENCE_TYPE_METHOD_H_
 ...
 * with finding the type of the FCO
 */
class Type_Method : public Method
{
public:
  /// Default constructor.
	Type_Method (void);
  ...
  /**
   * evaluate method for evaluating the type method
   *
...
#endif //_GAME_MODEL_INTELLIGENCE_TYPE_METHOD_CALL_H_