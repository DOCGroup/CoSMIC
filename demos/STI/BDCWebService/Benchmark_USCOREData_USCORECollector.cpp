#include "Benchmark_USCOREData_USCORECollector.h"
#include <string>
using std::string;
...
Benchmark_USCOREData_USCORECollector::Benchmark_USCOREData_USCORECollector ()
{
  Benchmark_USCOREData_USCORECollector_init(SOAP_IO_DEFAULT, SOAP_IO_DEFAULT);
}

Benchmark_USCOREData_USCORECollector::Benchmark_USCOREData_USCORECollector (soap_mode iomode)
{
  Benchmark_USCOREData_USCORECollector_init(iomode, iomode);
}

Benchmark_USCOREData_USCORECollector::Benchmark_USCOREData_USCORECollector (soap_mode imode, soap_mode omode)
{
  Benchmark_USCOREData_USCORECollector_init(imode, omode);
}
...
int Benchmark_USCOREData_USCORECollector::serve()
{
  #ifndef WITH_FASTCGI
...
static int serve_SLICE__collect_USCOREperformance_USCOREdata(Benchmark_USCOREData_USCORECollector*);

static int serve_SLICE__execution_USCOREtime(Benchmark_USCOREData_USCORECollector*);

static int serve_SLICE__unbind_USCOREto_USCOREpath(Benchmark_USCOREData_USCORECollector*);

static int serve_SLICE__bind_USCOREto_USCOREpath(Benchmark_USCOREData_USCORECollector*);

int Benchmark_USCOREData_USCORECollector::dispatch()
{
...
static int serve_SLICE__collect_USCOREperformance_USCOREdata(Benchmark_USCOREData_USCORECollector*soap)
{
...
static int serve_SLICE__execution_USCOREtime(Benchmark_USCOREData_USCORECollector*soap)
{
...
static int serve_SLICE__unbind_USCOREto_USCOREpath(Benchmark_USCOREData_USCORECollector*soap)
{
...
static int serve_SLICE__bind_USCOREto_USCOREpath(Benchmark_USCOREData_USCORECollector*soap)
{
...
int Benchmark_USCOREData_USCORECollector::collect_USCOREperformance_USCOREdata (struct SLICE__collect_USCOREperformance_USCOREdataResponse& _param_1)
{
  try
  {
