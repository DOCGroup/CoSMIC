...
namespace CQML
  {
    ...
    void DOMBuilder::initDocument (const std::string& rootName)
    {
      ...
      // Create the document
      this->doc_ =
        this->impl_->createDocument (GAME::Xml::String ("http://www.dre.vanderbilt.edu/RTSchedulabilityRequirements"),
    ...
    void DOMBuilder::initRootAttributes()
    {
      ...
      this->root_->setAttribute (GAME::Xml::String ("xsi:schemaLocation"),
                                 GAME::Xml::String ("http://www.dre.vanderbilt.edu/RTSchedulabilityRequirements RTSchedulabilityRequirements.xsd"));
