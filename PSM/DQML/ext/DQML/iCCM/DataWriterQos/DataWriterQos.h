...
namespace DQML
{
    ...
    public virtual ::GAME::Mga::Model_Impl
  {
    ...
    size_t src_of_PublishesConnection (std::vector <PublishesConnection> & items) const;
    GAME::Mga::Collection_T <PublishesConnection> src_of_PublishesConnection (void) const;
