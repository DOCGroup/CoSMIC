...
namespace DQML
{
    ...
    public virtual DomainEntity_Impl
  {
    ...
    bool has_src_of_dp_userdata_Connection (void) const;
    dp_userdata_Connection src_of_dp_userdata_Connection (void) const;
    ...
    bool has_src_of_dp_entityfactory_Connection (void) const;
    dp_entityfactory_Connection src_of_dp_entityfactory_Connection (void) const;
    ///@}
    ...
    dpf_dp_Connection dst_of_dpf_dp_Connection (void) const;
    ///@}
  };
}
