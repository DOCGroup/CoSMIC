...
namespace DQML
{
  ...
  //
  dw_res_Connection dw_res_Connection_Impl::_create (const DDSQoS_in parent)
  {
    return ::GAME::Mga::create_object < dw_res_Connection > (parent, dw_res_Connection_Impl::metaname);
  }
