...
namespace DQML
{
  ...
  //
  dr_history_Connection dr_history_Connection_Impl::_create (const DDSQoS_in parent)
  {
    return ::GAME::Mga::create_object < dr_history_Connection > (parent, dr_history_Connection_Impl::metaname);
  }
