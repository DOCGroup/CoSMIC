...
namespace DQML
{
  ...
  //
  dr_ownership_Connection dr_ownership_Connection_Impl::_create (const DDSQoS_in parent, DataReader_in src, OwnershipQosPolicy_in dst)
  {
    return ::GAME::Mga::Connection_Impl::_create (parent, dr_ownership_Connection_Impl::metaname, src, dst);
  }
