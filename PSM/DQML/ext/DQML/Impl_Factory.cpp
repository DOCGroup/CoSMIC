...
namespace DQML
{
  ...
  Impl_Factory::Impl_Factory (void)
  {
    ...
    this->map_.bind ("ListenerSchedulingQosPolicy", &::GAME::Mga::allocate_impl <ListenerSchedulingQosPolicy_Impl>);
    this->map_.bind ("SchedulingClassQosPolicy", &::GAME::Mga::allocate_impl <SchedulingClassQosPolicy_Impl>);
    ...
    this->map_.bind ("WatchdogSchedulingQosPolicy", &::GAME::Mga::allocate_impl <WatchdogSchedulingQosPolicy_Impl>);
    ...
    this->map_.bind ("SubscriptionKeyQosPolicy", &::GAME::Mga::allocate_impl <SubscriptionKeyQosPolicy_Impl>);
    ...
    this->map_.bind ("ReaderLifespanQosPolicy", &::GAME::Mga::allocate_impl <ReaderLifespanQosPolicy_Impl>);
    ...
    this->map_.bind ("SchedulingPriorityQosPolicy", &::GAME::Mga::allocate_impl <SchedulingPriorityQosPolicy_Impl>);
    ...
    this->map_.bind ("SchedulingQosPolicy", &::GAME::Mga::allocate_impl <SchedulingQosPolicy_Impl>);
    ...
    this->map_.bind ("StringSeq_Item", &::GAME::Mga::allocate_impl <StringSeq_Item_Impl>);
    ...
    this->map_.bind ("StringSeq", &::GAME::Mga::allocate_impl <StringSeq_Impl>);
    ...
    this->map_.bind ("ShareQosPolicy", &::GAME::Mga::allocate_impl <ShareQosPolicy_Impl>);
