...
{
  this->current_->setTextContent (String ("<!-- BEGIN DDS::DomainParticipantQoS parameters -->"));
  ...
  this->current_->setTextContent (String ("<!-- BEGIN DDS::DomainParticipantQoS(SchedulingQosPolicy) parameters -->"));
  ...
  if (topics.count() != 0)
      this->current_->setTextContent (String ("<!-- BEGIN DDS::TopicQoS parameters -->"));
  // topic(s) go here
  for (auto topic : topics)
    topic->accept (this);

  this->current_->setTextContent (String ("<!-- BEGIN DDS::PublisherQos parameters --"));
  // publisher(s) go here
  GAME::Mga::Collection_T <DQML::PublisherQos> publishers = item->get_PublisherQoss ();
  for (auto & publisher : publishers)
    publisher->accept (this);

  this->current_->setTextContent (String ("<!-- BEGIN DDS::SubscriberQoS parameters --"));
  ...
  this->current_->setTextContent (String ("<!-- BEGIN DDS::DataWriterQos parameters --"));
  ...
  this->current_->setTextContent (String ("<!-- BEGIN DDS::DataReaderQoS parameters --"));
