...
: fragment_ (parent.append_element ("type"))
{
...
{
  this->fragment_.append_simple_content ("kind", "tk_boolean");
}

void Data_Type_Visitor::
visit_Byte (PICML::Byte_in b)
{
  this->fragment_.append_simple_content ("kind", "tk_octet");
}
...
{
  this->fragment_.append_simple_content ("kind", "tk_char");
}

void Data_Type_Visitor::visit_WideChar (PICML::WideChar_in )
{
  this->fragment_.append_simple_content ("kind", "tk_wchar");
}

void Data_Type_Visitor::
visit_String (PICML::String_in s)
{
  this->fragment_.append_simple_content ("kind", "tk_string");
}

void Data_Type_Visitor::
visit_WideString (PICML::WideString_in s)
{
  this->fragment_.append_simple_content ("kind", "tk_wstring");
}

void Data_Type_Visitor::
visit_FloatNumber (PICML::FloatNumber_in fn)
{
  this->fragment_.append_simple_content ("kind", "tk_float");
}

void Data_Type_Visitor::
visit_DoubleNumber (PICML::DoubleNumber_in dn)
{
  this->fragment_.append_simple_content ("kind", "tk_double");
}

void Data_Type_Visitor::
visit_LongDoubleNumber (PICML::LongDoubleNumber_in dn)
{
  this->fragment_.append_simple_content ("kind", "tk_longdouble");
}

void Data_Type_Visitor::
visit_ShortInteger (PICML::ShortInteger_in si)
{
  this->fragment_.append_simple_content ("kind", "tk_short");
}

void Data_Type_Visitor::
visit_LongInteger (PICML::LongInteger_in li)
{
  this->fragment_.append_simple_content ("kind", "tk_long");
}

void Data_Type_Visitor::
visit_LongLongInteger (PICML::LongLongInteger_in li)
{
  this->fragment_.append_simple_content ("kind", "tk_longlong");
}

void Data_Type_Visitor::
visit_UnsignedShortInteger (PICML::UnsignedShortInteger_in si)
{
  this->fragment_.append_simple_content ("kind", "tk_ushort");
}
...
{
  this->fragment_.append_simple_content ("kind", "tk_ulong");
}

void Data_Type_Visitor::
visit_UnsignedLongLongInteger (PICML::UnsignedLongLongInteger_in li)
{
  this->fragment_.append_simple_content ("kind", "tk_ulonglong");
}

void Data_Type_Visitor::visit_Enum (PICML::Enum_in e)
{
  this->fragment_.append_simple_content ("kind", "tk_enum");
  GAME::Xml::Fragment enum_element = this->fragment_.append_element ("enum");

  // Write the name and typeId to the document.
  enum_element.append_simple_content ("name", e->name ());
  enum_element.append_simple_content ("typeId", PICML::repository_id (e));
...
{
  this->fragment_.append_simple_content ("member", ev->name ());
}
...
{
  this->fragment_.append_simple_content ("kind", "tk_sequence");
  GAME::Xml::Swap_Fragment sequence (this->fragment_, this->fragment_.append_element ("sequence"));

  // Make sure we account for the sequence's size.
  std::string bound = c->bound ();

  if (!bound.empty ())
    this->fragment_.append_simple_content ("bound", bound);

  // Start the elementType for this part of the document.
  GAME::Xml::Swap_Fragment elementType (this->fragment_, this->fragment_.append_element ("elementType"));
...
{
  this->fragment_.append_simple_content ("kind", "tk_struct");
  GAME::Xml::Swap_Fragment aggregate (this->fragment_, this->fragment_.append_element ("struct"));

  // Write the name and typeId to the document.
  aggregate.append_simple_content ("name", aggr->name ());
  aggregate.append_simple_content ("typeId", PICML::repository_id (aggr));
...
void Data_Type_Visitor::visit_Member (PICML::Member_in m)
{
  ...
  member.append_simple_content ("name", m->name ());
