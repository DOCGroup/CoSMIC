...
namespace PICML
{
  ...
  // get_ComplexPropertys
  //
  ::GAME::Mga::Iterator <ComplexProperty> Paths_Impl::get_ComplexPropertys (void) const
  {
  ...
  // get_SimplePropertys
  //
  ::GAME::Mga::Iterator <SimpleProperty> Paths_Impl::get_SimplePropertys (void) const
  {
