...
namespace PICML
{
    ...
    public virtual ::GAME::Mga::FCO_Impl
  {
    ...
    bool has_dst_of_AttributeValue (void) const;
    AttributeValue dst_of_AttributeValue (void) const;
    ...
    bool has_dst_of_AssemblyConfigProperty (void) const;
    AssemblyConfigProperty dst_of_AssemblyConfigProperty (void) const;
