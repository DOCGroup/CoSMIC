...
namespace PICML
{
  ...
  Impl_Factory::Impl_Factory (void)
  {
    ...
    this->map_.bind ("CallAction", &::GAME::Mga::allocate_impl <CallAction_Impl>);
    ...
    this->map_.bind ("TemplateParameterReference", &::GAME::Mga::allocate_impl <TemplateParameterReference_Impl>);
