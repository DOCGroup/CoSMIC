...
namespace PICML
{
  ...
  // is_abstract
  //
  const bool Collection_Impl::is_abstract = false;
  ...
  {
    return ::GAME::Mga::create < Collection > (parent, Collection_Impl::metaname);
  }
  ...
  //
  void Collection_Impl::refers_to_MemberType (MemberType_in item)
  {
    this->refers_to (item);
  }
