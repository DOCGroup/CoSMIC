...
namespace PICML
{
  ...
  // is_abstract
  //
  const bool AttributeMember_Impl::is_abstract = false;
  ...
  {
    return ::GAME::Mga::create < AttributeMember > (parent, AttributeMember_Impl::metaname);
  }
  ...
  //
  void AttributeMember_Impl::refers_to_MemberType (MemberType_in item)
  {
    this->refers_to (item);
  }
  ...
  // refers_to_MemberType
  //
  MemberType AttributeMember_Impl::refers_to_MemberType (void) const
  {
