...
void
EnumEditControl::add_select_listener(Enum_Edit_Control_Select_Listener* l)
{
  select_listeners_.push_back(l);
}

void
EnumEditControl::add_focus_listener(Enum_Edit_Control_Focus_Listener* l)
{
...
{
  if (events_enabled_)
    for (std::list<Enum_Edit_Control_Focus_Listener*>::iterator
