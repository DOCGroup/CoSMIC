...
/**
 * Domain specific class of <code>InputRef</code>.
 */
public class InputRef extends IORef
{
	// meta information
	public static final String META_TYPE = "InputRef";
	 ...
	 */
	protected InputRef(UdmPseudoObject upo, Diagram metaDiagram)
		throws UdmException
	{
	 ...
	 * @return  An instance of the class <code>InputRef</code>
	 * @throws  UdmException If any Udm related exception occured
	 */
	public static InputRef create(BindingOperation parent)
		throws UdmException
	{
		Diagram metaDiagram = parent.getDiagram();
		return new InputRef(parent.createObject(META_TYPE, META_TYPE_NS), metaDiagram);
	}
		...
		throws UdmException
	{
		...
		return (Input[]) Utils.wrapWithSubclass(objs, Input.class, getDiagram());
	}
